...
public class f extends AutoCompleteTextView implements s {
    private static final int[] a;
    private final g b;
    private final w c;

    static {
        f.a = new int[]{16843126};
    }
    ...
    public f(Context arg3, AttributeSet arg4, int arg5) {
        super(bh.a(arg3), arg4, arg5);
        bk v3 = bk.a(this.getContext(), arg4, f.a, arg5, 0);
        if(v3.g(0)) {
