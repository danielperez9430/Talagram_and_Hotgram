...
public class ActionMenuView extends ap implements b, p {
    ...
    public Menu getMenu() {
        android.support.v7.widget.ActionMenuView$b v1_1;
        if(this.c == null) {
            ...
            if(this.h != null) {
                android.support.v7.view.menu.o$a v1 = this.h;
            }
            else {
                v1_1 = new android.support.v7.widget.ActionMenuView$b();
            }

            v0_1.a(((android.support.v7.view.menu.o$a)v1_1));
