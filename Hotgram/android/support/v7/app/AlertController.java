...
class AlertController {
    ...
    public class a {
        ...
        private void b(AlertController arg11) {
            android.support.v7.app.AlertController$a$3 v1_1;
            SimpleCursorAdapter v9_2;
            ...
            if(!this.G) {
                ...
                int v2 = 16908308;
                if(this.K != null) {
                    v9_2 = new SimpleCursorAdapter(this.a, v4, this.K, new String[]{this.L}, new int[]{v2});
                    goto label_63;
                }
                ...
                c v9_4 = new c(this.a, v4, v2, this.v);
            }
            else if(this.K == null) {
        ...
        label_63:
            ...
            arg11.j = ((ListAdapter)v9_2);
            arg11.k = this.I;
            if(this.x != null) {
                v1_1 = new AdapterView$OnItemClickListener(arg11) {
            ...
            label_74:
                ((RecycleListView)v0).setOnItemClickListener(((AdapterView$OnItemClickListener)v1_1));
            }
