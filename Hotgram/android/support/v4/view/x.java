...
public final class x {
    ...
    public x a(aa arg4) {
        android.support.v4.view.x$2 v1_1;
        Object v0 = this.d.get();
        if(v0 != null && Build$VERSION.SDK_INT >= 19) {
            ValueAnimator$AnimatorUpdateListener v1 = null;
            if(arg4 != null) {
                v1_1 = new ValueAnimator$AnimatorUpdateListener(arg4, ((View)v0)) {
            ...
            ((View)v0).animate().setUpdateListener(((ValueAnimator$AnimatorUpdateListener)v1_1));
        }
