...
public class ViewPager extends ViewGroup {
    ...
    private b infoForCurrentScrollPosition() {
        ...
        while(true) {
            ...
            v10 = this.mItems.get(v1);
            if(v3 == 0) {
                ++v7;
                if(((b)v10).b != v7) {
                    b v10_1 = this.mTempItem;
                    v10_1.e = v8 + v9 + v0_1;
                    v10_1.b = v7;
                    ((b)v10).d = this.mAdapter.getPageWidth(((b)v10).b);
                    --v1;
                }
            }

            v8 = ((b)v10).e;
            float v7_1 = ((b)v10).d + v8 + v0_1;
            if(v3 == 0) {
                if(v2 >= v8) {
                }
                else {
    ...
    void populate(int arg18) {
        ...
        label_51:
            ...
            if(v8_1 != null) {
                ...
                float v13 = 2f;
                float v3 = v12 <= 0 ? 0f : v13 - v8_1.d + (((float)this.getPaddingLeft())) / (((float)v12));
                ...
                v0.mAdapter.setPrimaryItem(((ViewGroup)v0), v0.mCurItem, v8_1.a);
            }
