...
final class m extends l implements LayoutInflater$Factory2 {
    ...
    void a(Parcelable arg13, n arg14) {
        ...
        for(v2_1 = 0; v2_1 < ((FragmentManagerState)arg13).a.length; ++v2_1) {
            ...
            if(v5_1 != null) {
                ...
                Fragment v6_1 = v5_1.a(this.m, this.n, this.o, v10_2, v11_1);
                if(m.a) {
    ...
    label_420:
        ...
        if(v7.mState != v8_1) {
            Log.w("FragmentManager", "moveToState: Fragment state for " + arg15 + " not updated inline; " + "expected state " + v8_1 + " found " + v7.mState);
            v7.mState = v8_1;
        }
    }
    ...
    public String toString() {
        ...
        android.support.v4.f.d.a(v1_1, v0);
        v0.append("}}");
        return v0.toString();
    }
