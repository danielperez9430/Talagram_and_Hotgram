...
public final class SpliceInfoDecoder implements MetadataDecoder {
    ...
    public Metadata decode(MetadataInputBuffer arg8) {
        ...
        label_57:
            ...
            goto label_69;
        label_61:
            SpliceScheduleCommand v4_2 = SpliceScheduleCommand.parseFromSection(this.sectionData);
        }
        else {
            v4_3 = PrivateCommand.parseFromSection(this.sectionData, v8_1, v1);
        }

    label_69:
        Metadata v0_1 = (((TimeSignalCommand)v4_3)) == null ? new Metadata(new Entry[0]) : new Metadata(new Entry[]{((TimeSignalCommand)v4_3)});
        return v0_1;
    }
}
