...
@TargetApi(value=18) class DefaultDrmSession implements DrmSession {
    @SuppressLint(value={"HandlerLeak"}) class PostRequestHandler extends Handler {
        ...
        public void handleMessage(Message arg6) {
            ...
            label_5:
                v1_1 = DefaultDrmSession.this.callback.executeKeyRequest(DefaultDrmSession.this.uuid, v0.first, v0.second);
                goto label_27;
            label_14:
        ...
        label_27:
            DefaultDrmSession.this.postResponseHandler.obtainMessage(arg6.what, Pair.create(v0, v1_1)).sendToTarget();
        }
