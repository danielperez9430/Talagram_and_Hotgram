...
public final class zzr {
    ...
    static {
        zzr.UTF_8 = Charset.forName("UTF-8");
        zzr.ISO_8859_1 = Charset.forName("ISO-8859-1");
        zzr.zzhk = new Object();
    }
    ...
    public static int hashCode(float[] arg1) {
        if(arg1 != null) {
            if(arg1.length == 0) {
            }
            else {
    ...
    public static void zza(zzn arg1, zzn arg2) {
        if(arg1.zzhc != null) {
            arg2.zzhc = arg1.zzhc.clone();
        }
    }
}
