...
abstract class zzjz {
    ...
    abstract int zzc(CharSequence arg1, byte[] arg2, int arg3, int arg4);

    abstract void zzc(CharSequence arg1, ByteBuffer arg2);

    abstract int zzc(int arg1, byte[] arg2, int arg3, int arg4);

    static void zzd(CharSequence arg7, ByteBuffer arg8) {
        byte v6;
        int v5;
        char v4_1;
        int v4;
    ...
    final boolean zzh(byte[] arg2, int arg3, int arg4) {
        if(this.zzc(0, arg2, arg3, arg4) == 0) {
            return 1;
        }
