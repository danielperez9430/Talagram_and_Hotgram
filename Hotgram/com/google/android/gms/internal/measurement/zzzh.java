...
public final class zzzh {
    private static void zza(String arg12, Object arg13, StringBuffer arg14, StringBuffer arg15) {
        ...
        int v4_1;
        if(arg13 != null) {
            if((arg13 instanceof zzzg)) {
                int v0 = arg14.length();
                if(arg12 != null) {
                    arg15.append(arg14);
                    arg15.append(zzzh.zzgc(arg12));
                    arg15.append(" <\n");
                    arg14.append("  ");
                }
                    ...
                    if(!"cachedSize".equals(v9) && (v8 & 1) == 1 && (v8 & 8) != 8 && !v9.startsWith("_") && !v9.endsWith("_")) {
                        ...
                        if((v8_1.isArray()) && v8_1.getComponentType() != Byte.TYPE) {
                            ...
                            for(v10 = 0; true; ++v10) {
                                ...
                                zzzh.zza(v9, Array.get(v7_1, v10), arg14, arg15);
                            }
                        }

                        zzzh.zza(v9, v7_1, arg14, arg15);
                    }
                ...
                for(v5 = 0; v5 < v4_1; ++v5) {
                    ...
                    if(v6_1.startsWith("set")) {
                        ...
                        zzzh.zza(v6_1, v7_3.invoke(arg13), arg14, arg15);
                    }
    ...
    public static String zzc(zzzg arg3) {
        String v3_2;
        String v0_1;
        if(arg3 == null) {
            return "";
        ...
        String v1 = null;
        try {
            zzzh.zza(v1, arg3, new StringBuffer(), v0);
        }
    ...
    private static String zzgc(String arg4) {
        StringBuffer v0 = new StringBuffer();
        int v1;
