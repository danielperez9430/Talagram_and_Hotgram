...
@Class(creator="AnalyticsUserPropertyCreator") @Reserved(value={1}) public final class zzl extends AbstractSafeParcelable {
    ...
    @Constructor public zzl(@Param(id=2) String arg1, @Param(id=3) String arg2) {
        super();
        this.mName = arg1;
        this.mValue = arg2;
    }
