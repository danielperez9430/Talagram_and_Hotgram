...
public final class zzag implements Parcelable$Creator {
    ...
    public final Object createFromParcel(Parcel arg24) {
        ...
        label_67:
            ...
            continue;
        label_35:
            Parcelable v20_1 = SafeParcelReader.createParcelable(v0, v2, zzam.CREATOR);
            continue;
        label_71:
        ...
        label_59:
            ...
            continue;
        label_61:
            v14_1 = SafeParcelReader.createParcelable(v0, v2, LatLngBounds.CREATOR);
            continue;
        label_29:
            v22 = SafeParcelReader.createString(v0, v2);
            continue;
        label_31:
            Parcelable v21_1 = SafeParcelReader.createParcelable(v0, v2, zzah.CREATOR);
        }

        SafeParcelReader.ensureAtEnd(v0, v1);
        return new PlaceEntity(v6, ((List)v7_1), v8, v9, v10, v11, v12, v13, ((LatLngBounds)v14_1), v15, ((Uri)v16_1), v17, v18, v19, v20, v21, v22);
    }
