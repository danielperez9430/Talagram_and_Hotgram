...
@Class(creator="ChannelSendFileResponseCreator") @Reserved(value={1}) public final class zzbp extends AbstractSafeParcelable {
    public static final Parcelable$Creator CREATOR;
    @Field(id=2) public final int statusCode;

    static {
        zzbp.CREATOR = new zzbq();
    }

    @Constructor public zzbp(@Param(id=2) int arg1) {
        super();
