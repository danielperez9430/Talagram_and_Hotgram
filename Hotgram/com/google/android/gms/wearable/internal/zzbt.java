...
@Class(creator="CloseChannelResponseCreator") @Reserved(value={1}) public final class zzbt extends AbstractSafeParcelable {
    public static final Parcelable$Creator CREATOR;
    @Field(id=2) public final int statusCode;

    static {
        zzbt.CREATOR = new zzbu();
    }

    @Constructor public zzbt(@Param(id=2) int arg1) {
        super();
