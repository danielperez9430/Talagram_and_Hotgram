...
public final class WalletConstants {
    @Retention(value=RetentionPolicy.SOURCE) @public interface BillingAddressFormat {
    }

    @Retention(value=RetentionPolicy.SOURCE) @public interface CardClass {
    }

    @Retention(value=RetentionPolicy.SOURCE) @public interface CardNetwork {
        @Deprecated public static final int AMEX = 1;
        @Deprecated public static final int DISCOVER = 2;
        @Deprecated public static final int INTERAC = 6;
        @Deprecated public static final int JCB = 3;
        @Deprecated public static final int MASTERCARD = 4;
        @Deprecated public static final int OTHER = 1000;
        @Deprecated public static final int VISA = 5;

    }

    @Retention(value=RetentionPolicy.SOURCE) @public interface PaymentMethod {
    }

    @Retention(value=RetentionPolicy.SOURCE) @public interface PaymentMethodTokenizationType {
    }

    @Retention(value=RetentionPolicy.SOURCE) @public interface TotalPriceStatus {
    }

    @Deprecated public static final String ACTION_ENABLE_WALLET_OPTIMIZATION = "com.google.android.gms.wallet.ENABLE_WALLET_OPTIMIZATION";
    ...
    @Deprecated public static final int ENVIRONMENT_SANDBOX = 0;
    @Deprecated public static final int ENVIRONMENT_STRICT_SANDBOX = 2;
    ...
    @Deprecated public static final int ERROR_CODE_SPENDING_LIMIT_EXCEEDED = 406;
    ...
    @Deprecated public static final int PAYMENT_METHOD_TOKENIZATION_TYPE_NETWORK_TOKEN = 2;
    ...
    @Deprecated public static final int THEME_HOLO_DARK = 0;
    @Deprecated public static final int THEME_HOLO_LIGHT = 1;
    ...
    private static final Account zzeu;

    static {
        WalletConstants.zzeu = new Account("ACCOUNT_NO_WALLET", "com.google");
    }
