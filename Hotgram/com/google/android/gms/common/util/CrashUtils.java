    ...
    label_18:
        ...
        label_20:
            ...
            if(CrashUtils.zzzd != null) {
                DropBoxManager v8_1 = CrashUtils.zzzd;
            }
            else {
                v8_2 = arg4.getSystemService("dropbox");
            }

            if((((DropBoxManager)v8_2)) != null) {
                if(!((DropBoxManager)v8_2).isTagEnabled("system_app_crash")) {
                }
                else {
                    ((DropBoxManager)v8_2).addText("system_app_crash", CrashUtils.zza(arg4, arg5, arg6, arg7));
                    goto label_36;
                }
            }
