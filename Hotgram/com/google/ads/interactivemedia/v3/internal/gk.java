...
public final class gk extends gf {
    ...
    static {
        gk.a = new Class[]{Integer.TYPE, Long.TYPE, Short.TYPE, Float.TYPE, Double.TYPE, Byte.TYPE, Boolean.TYPE, Character.TYPE, Integer.class, Long.class, Short.class, Float.class, Double.class, Byte.class, Boolean.class, Character.class};
    }

    public gk(Boolean arg1) {
        super();
        this.a(arg1);
    }

    public gk(Number arg1) {
        super();
        this.a(arg1);
    }

    public gk(String arg1) {
        super();
        this.a(arg1);
    }
    ...
    void a(Object arg2) {
        ...
        if((arg2 instanceof Character)) {
            ...
            boolean v0 = ((arg2 instanceof Number)) || (gk.b(arg2)) ? true : false;
            gw.a(v0);
        }
    ...
    private static boolean a(gk arg2) {
        boolean v1 = false;
    ...
    public boolean equals(Object arg7) {
        ...
        if(arg7 != null) {
            if(this.getClass() != arg7.getClass()) {
                ...
                if((gk.a(this)) && (gk.a(((gk)arg7)))) {
                    if(this.a().longValue() == ((gk)arg7).a().longValue()) {
                    }
                    else {
                        v0 = false;
                    }
                ...
                if(((this.b instanceof Number)) && ((((gk)arg7).b instanceof Number))) {
                    double v2 = this.a().doubleValue();
                    double v4 = ((gk)arg7).a().doubleValue();
                ...
                return this.b.equals(((gk)arg7).b);
            }
        }
