            ...
            if(((RecyclerView)v4).getWindowVisibility() != 0) {
                ...
                for(v3 = 0; v3 < v5.mCount * 2; v3 += 2) {
                    if(v7 >= this.mTasks.size()) {
                        ...
                        v8_1 = this.mTasks.get(v7);
                    }

                    int v9 = v5.mPrefetchArray[v3 + 1];
                    boolean v10 = v9 <= v6 ? true : false;
                    ((Task)v8_1).immediate = v10;
                    ((Task)v8_1).viewVelocity = v6;
                    ((Task)v8_1).distanceToItem = v9;
                    ((Task)v8_1).view = ((RecyclerView)v4);
                    ((Task)v8_1).position = v5.mPrefetchArray[v3];
                    ++v7;
                }
