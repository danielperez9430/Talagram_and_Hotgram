...
public class DataQuery {
        ...
        while(v7_1.hasNext()) {
            ...
            try {
                ...
                if(((String)v1).startsWith("r_")) {
                    Message v0_3 = Message.TLdeserialize(((AbstractSerializedData)v2), v2.readInt32(true), true);
    ...
    public void addRecentSticker(int arg11, Document arg12, int arg13, boolean arg14) {
        ...
        if(DataQuery.recentStickers[arg11].size() > v2 || (arg14)) {
            if(arg14) {
                ...
                v2_4 = DataQuery.recentStickers[arg11].remove(DataQuery.recentStickers[arg11].size() - 1);
            }

            MessagesStorage.getInstance(DataQuery.currentAccount).getStorageQueue().postRunnable(new Runnable(arg11, ((Document)v2_4)) {
                public void run() {
                    int v0;
                    if(this.val$type == 0) {
                        v0 = 3;
                ...
                label_183:
                    ...
                    if((arg20[0] instanceof Spanned)) {
                                ...
                                if(!DataQuery.checkInclusion(v9, v6) && !DataQuery.checkInclusion(v11, v6)) {
                                    if(DataQuery.checkIntersection(v9, v11, v6)) {
                                        ...
                                        if(((TypefaceSpan)v5_1).isMono()) {
                                            v5_2 = new TL_messageEntityCode();
                                        }
                                        else if(((TypefaceSpan)v5_1).isBold()) {
                                            TL_messageEntityBold v5_3 = new TL_messageEntityBold();
                                        }
                                        else {
                                            TL_messageEntityItalic v5_4 = new TL_messageEntityItalic();
                                        }

                                        ((MessageEntity)v5_2).offset = v9;
                                        ((MessageEntity)v5_2).length = v11 - v9;
                                        v6.add(v5_2);
                                    }
                                }
                            }
                        ...
                        if(v3_1 != null && v3_1.length > 0) {
                            ...
                            for(v4 = 0; v4 < v3_1.length; ++v4) {
                                TL_inputMessageEntityMentionName v5_5 = new TL_inputMessageEntityMentionName();
                        ...
                        for(v4 = 0; v4 < v3_1.length; ++v4) {
                            ...
                            ((TL_messageEntityTextUrl)v5_2).length = Math.min(((Spanned)v1_4).getSpanEnd(v3_1[v4]), arg20[0].length()) - ((TL_messageEntityTextUrl)v5_2).offset;
    ...
    public void increaseInlineRaiting(int arg9) {
        ...
        v2_1.rating += Math.exp(((double)(v0 / MessagesController.getInstance(DataQuery.currentAccount).ratingDecay)));
        ...
        this.savePeer(arg9, 1, v2_1.rating);
        NotificationCenter.getInstance(DataQuery.currentAccount).postNotificationName(NotificationCenter.reloadInlineHints, new Object[0]);
    }
                    ...
                    label_35:
                        AndroidUtilities.runOnUIThread(new Runnable(v0) {
                            ...
                            label_38:
                                ...
                                this.this$1.this$0.savePeer(((int)this.this$1.val$did), 0, ((TL_topPeer)v2).rating);
                                NotificationCenter.getInstance(DataQuery.currentAccount).postNotificationName(NotificationCenter.reloadHints, new Object[0]);
                            }
                        });
                    }
    ...
    public void loadRecents(int arg6, boolean arg7, boolean arg8, boolean arg9) {
        TL_messages_getRecentStickers v8_4;
        ...
        label_56:
            if(arg7) {
                ...
                if(arg6 == 2) {
                    TL_messages_getFavedStickers v8_3 = new TL_messages_getFavedStickers();
                    v8_3.hash = DataQuery.calcDocumentsHash(DataQuery.recentStickers[arg6]);
                }
                else {
                    v8_4 = new TL_messages_getRecentStickers();
            ...
            v9_1.sendRequest(((TLObject)v8_4), ((RequestDelegate)v0_1));
        }
    }
        ...
        if(arg14) {
            if(arg12.reply_to_msg_id != 0 && arg13 == null) {
                ...
                MessagesStorage.getInstance(DataQuery.currentAccount).getStorageQueue().postRunnable(new Runnable(v3, v5, arg10) {
                    public void run() {
                        org.telegram.messenger.DataQuery$63$2 v2_2;
                        ConnectionsManager v1_1;
                        TL_channels_getMessages v0_2;
                        Message v0 = null;
                        try {
                            ...
                            if(v0 == null) {
                                if(this.val$channelIdFinal != 0) {
                                    ...
                                    v1_1 = ConnectionsManager.getInstance(DataQuery.currentAccount);
                                    org.telegram.messenger.DataQuery$63$1 v2_1 = new RequestDelegate() {
                                        public void run(TLObject arg4, TL_error arg5) {
                                ...
                                v1_1.sendRequest(((TLObject)v0_2), ((RequestDelegate)v2_2));
                                return;
                            }
