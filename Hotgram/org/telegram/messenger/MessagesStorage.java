...
public class MessagesStorage {
    ...
    public static void lambda$getBotCache$61(MessagesStorage arg4, int arg5, String arg6, RequestDelegate arg7) {
        TL_messages_botCallbackAnswer v1_3;
        ...
        try {
            ...
            if(v6_1 != null) {
                ...
                if(v1_2 == TL_messages_botCallbackAnswer.constructor) {
                    v1_3 = TL_messages_botCallbackAnswer.TLdeserialize(((AbstractSerializedData)v6_1), v1_2, false);
                }
                else {
    ...
    label_97:
        ...
        try {
            ...
            label_34:
                ...
                v13_2.shortPhones.add(v15);
                v13_2.phoneDeleted.add(Integer.valueOf(v7.b(v4)));
                v13_2.phoneTypes.add("");
            }
            while(v14.size() != v11);
    ...
    label_260:
        ...
        try {
            ...
            label_187:
                ...
                v13_2.shortPhones.add(v14_2);
                v13_2.phoneDeleted.add(Integer.valueOf(v9.b(v2)));
                v13_2.phoneTypes.add("");
            }
            while(v7_1.size() != v11);
            ...
            if(v6_2.a()) {
                ...
                if(v7 != null) {
                    ...
                    if((v0 instanceof TL_messageMediaDocument)) {
                        Document v7_1 = ((TL_messageMediaDocument)v0).document;
                    }
                    else if((v0 instanceof TL_messageMediaPhoto)) {
                        v7_2 = ((TL_messageMediaPhoto)v0).photo;
                    }
                    else {
                        goto label_31;
                    }
            ...
            label_53:
                ...
                while(v2 < v1_1.participants.participants.size()) {
                    ...
                    if(((ChatParticipant)v7_2).user_id == arg8) {
                        if(arg9 == 1) {
                            v8 = new TL_chatParticipantAdmin();
                            ...
                            TL_chatParticipant v8_1 = new TL_chatParticipant();
                            ((ChatParticipant)v8_1).user_id = ((ChatParticipant)v7_2).user_id;
                            ((ChatParticipant)v8_1).date = ((ChatParticipant)v7_2).date;
                            arg7 = ((ChatParticipant)v7_2).inviter_id;
                        }

                        ((ChatParticipant)v8).inviter_id = arg7;
                        v1_1.participants.participants.set(v2, v8);
                        break;
                    }
            ...
            label_244:
                while(v0_4.a()) {
                    ...
                    if(v6_2 == null) {
                        ...
                        v10_5 = ((LongSparseArray)v6_2).get(v8_3);
                    }

                    if((((Integer)v10_5)) == null) {
                        v10_4 = Integer.valueOf(0);
                    }

                    ((LongSparseArray)v6_2).put(v8_3, Integer.valueOf(((Integer)v10_5).intValue() + 1));
                    v7 = 0;
                }
            ...
            while(true) {
                ...
                if(v9_1 != (((long)v7))) {
                    ...
                    if(v8_1.b(3) == 0) {
                        ...
                        if(v0 < v11) {
                            v12_1[1] = Integer.valueOf(v12_1[1].intValue() + 1);
                        }
                        ...
                        v12_1[0] = Integer.valueOf(v12_1[0].intValue() + 1);
                    }
            ...
            label_49:
                ...
                label_273:
                    ...
                    while(v4_1 < v3.size()) {
                        ...
                        ((LongSparseArray)v6_2).put(v8_3, Integer.valueOf(v14_1.intValue() + 1));
                        ++v4_1;
                        v27 = v11;
                    }
                }
            ...
            label_316:
                ...
                label_331:
                    ...
                    while(v3_5 < v4_3.size()) {
                        ...
                        if(v9_3 == null) {
                            v9_4 = Integer.valueOf(0);
                        }

                        v8_2.put(v5, Integer.valueOf(v9_4.intValue() + 1));
                        ++v3_5;
                        v26 = v8_2;
                    }
    ...
    label_745:
        ...
        label_806:
            ...
            if(v19_1 == null) {
                Integer v19_2 = Integer.valueOf(0);
            }
            else {
            ...
            v2_8.a(3, v14_3 + v20_3.intValue());
            v2_8.a(4, v10_4);
            v2_8.a(5, v15_2);
            v2_8.a(6, v41);
            v2_8.a(7, 0);
            v2_8.a(8, v23_1 + ((Integer)v19_1).intValue());
            v2_8.a(9, v5_3);
            v2_8.a(10, 0);
            v2_8.a(11, v1_1);
            v2_8.a(12, v40);
    ...
    private void putUsersInternal(ArrayList arg11) {
        ...
        if(arg11 != null && !arg11.isEmpty()) {
            ...
            for(v2 = 0; v2 < arg11.size(); ++v2) {
                ...
                v3_1.serializeToStream(((AbstractSerializedData)v4_1));
                v0.a(1, v3_1.id);
                v0.a(2, this.formatUserSearchName(v3_1));
                int v6_2 = 3;
                if(v3_1.status != null) {
                    if((v3_1.status instanceof TL_userStatusRecently)) {
                        v5 = v3_1.status;
                        v7_1 = -100;
                        goto label_81;
                    }
                    else if((v3_1.status instanceof TL_userStatusLastWeek)) {
                        v5 = v3_1.status;
                        v7_1 = -101;
                        goto label_81;
                    }
                    else if((v3_1.status instanceof TL_userStatusLastMonth)) {
                        v5 = v3_1.status;
                        v7_1 = -102;
                    label_81:
                        v5.expires = v7_1;
