...
public class SendMessagesHelper implements NotificationCenterDelegate {
        ...
        if(v0 == NotificationCenter.FileDidUpload) {
            ...
            while(v13 < ((ArrayList)v4).size()) {
                ...
                if(v15 == null || (((InputMedia)v0_2)) == null) {
                    ...
                    if(v3 != null) {
                        if(((((TL_decryptedMessage)v3).media instanceof TL_decryptedMessageMediaVideo)) || ((((TL_decryptedMessage)v3).media instanceof TL_decryptedMessageMediaPhoto)) || ((((TL_decryptedMessage)v3).media instanceof TL_decryptedMessageMediaDocument))) {
                            ((TL_decryptedMessage)v3).media.size = ((int)arg30[5].longValue());
                        }

                        ((TL_decryptedMessage)v3).media.key = arg30[v8];
                        ((TL_decryptedMessage)v3).media.iv = arg30[v11];
                        if(((DelayedMessage)v1).type == v11) {
                            v6.uploadMultiMedia(((DelayedMessage)v1), ((InputMedia)v10), ((InputEncryptedFile)v2_2), ((String)v14));
                            goto label_254;
                        }

                        SecretChatHelper.getInstance(v6.currentAccount).performSendEncryptedRequest(v3, ((DelayedMessage)v1).obj.messageOwner, ((DelayedMessage)v1).encryptedChat, v2_2, ((DelayedMessage)v1).originalPath, ((DelayedMessage)v1).obj);
                    }
            ...
            if(v0 == NotificationCenter.FileDidFailUpload) {
                ...
                if(v0 == NotificationCenter.FilePreparingStarted) {
                    ...
                    v0_3 = ((MessageObject)v0_2).messageOwner.attachPath;
                    goto label_596;
                }
                ...
                if(v0 == NotificationCenter.httpFileDidLoaded) {
                    ...
                    label_524:
                        if(v0 == 0) {
                            ...
                            Utilities.globalQueue.postRunnable(new -$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY(this, new File(FileLoader.getDirectory(v11), v0_5.toString()), v3_5, ((DelayedMessage)v4), v7_1));
                        }
                        else if(v0 == 1) {
                            v0_5 = new StringBuilder();
                            v0_5.append(Utilities.MD5(((String)v7_1)));
                            v0_5.append(".gif");
                            Utilities.globalQueue.postRunnable(new -$$Lambda$SendMessagesHelper$pp0U4GJ1r75dDYF4YGnbf9kI6EU(v6, ((DelayedMessage)v4), new File(FileLoader.getDirectory(v11), v0_5.toString()), v3_5));
                        }
                    }
    ...
    private void editMessageMedia(MessageObject arg21, TL_photo arg22, VideoEditedInfo arg23, TL_document arg24, String arg25, HashMap arg26, boolean arg27) {
        ...
        try {
            ...
            if(arg27) {
                if((v2.messageOwner.media instanceof TL_messageMediaPhoto)) {
                    Photo v0_2 = v2.messageOwner.media.photo;
                    v3 = arg23;
                    v5_1 = 2;
                }
                else {
                    Document v4_1 = v2.messageOwner.media.document;
        ...
        label_226:
            ...
            if(v12_1 != 2) {
                if(v12_1 != 3) {
                    ...
                    if(v4.access_hash == 0) {
                        if(v13_1 == null || ((String)v13_1).length() <= 0 || !((String)v13_1).startsWith("http") || v11 == null) {
                            ...
                            v5_2.type = 2;
                            v5_2.obj = v2;
                            v5_2.location = v4.thumb.location;
                        }
                        else {
                            TL_inputMediaGifExternal v3_6 = new TL_inputMediaGifExternal();
                        ...
                        ((InputMedia)v3_4).mime_type = v4.mime_type;
                        ((InputMedia)v3_4).attributes = v4.attributes;
                        goto label_392;
                    }
                ...
                else if(v4.access_hash == 0) {
                    TL_inputMediaUploadedDocument v5_3 = new TL_inputMediaUploadedDocument();
                    ((InputMedia)v5_3).mime_type = v4.mime_type;
                    ((InputMedia)v5_3).attributes = v4.attributes;
                    if(!arg21.isGif()) {
                        if(v3 != null && (v3.muted)) {
                            goto label_309;
                        }
                    ...
                    v7_2.location = v4.thumb.location;
            ...
            label_391:
                ...
                if(v5 == null || v5.length() <= 0 || !v5.startsWith("http")) {
                    v6_3.location = v0.sizes.get(v0.sizes.size() - 1).location;
                }
                else {
                ...
                v3_3.id.id = v0.id;
                v3_3.id.access_hash = v0.access_hash;
                goto label_391;
            }
        ...
        label_392:
            ...
            ((TL_messages_editMessage)v6_4).flags |= 16384;
        ...
        if((arg9) && arg10 == null) {
            ...
            if((arg12 instanceof TL_keyboardButtonBuy)) {
                ...
                if(((TL_messages_botCallbackAnswer)arg10).message != null) {
                    ...
                    arg13.showAlert(v9_1, ((TL_messages_botCallbackAnswer)arg10).message);
                    return;
                }
    ...
    public static void lambda$null$18(SendMessagesHelper arg5, TLObject arg6, InputMedia arg7, DelayedMessage arg8) {
        ...
        if(arg6 != null) {
            ...
            TL_inputMediaDocument v0_1 = new TL_inputMediaDocument();
    ...
    label_38:
        if(v0 != null) {
            if(arg7.ttl_seconds != 0) {
                ((InputMedia)v0).ttl_seconds = arg7.ttl_seconds;
                ((InputMedia)v0).flags |= 1;
            }
            ...
            while(v3 < ((TL_messages_sendMultiMedia)arg6).multi_media.size()) {
                if(((TL_messages_sendMultiMedia)arg6).multi_media.get(v3).media == arg7) {
                    ((TL_messages_sendMultiMedia)arg6).multi_media.get(v3).media = ((InputMedia)v0);
                }
                else {
                    ++v3;
                    continue;
    ...
    public static void lambda$performSendMessageRequest$39(SendMessagesHelper arg9, TLObject arg10, Message arg11, MessageObject arg12, String arg13, TLObject arg14, TL_error arg15) {
        -$$Lambda$SendMessagesHelper$JzHPMv1zxGjgZi0McML88SKn2E0 v0_1;
        if((arg10 instanceof TL_messages_editMessage)) {
            -$$Lambda$SendMessagesHelper$_VEctUoqz2Ju1DWusW06IpqoYCM v0 = new -$$Lambda$SendMessagesHelper$_VEctUoqz2Ju1DWusW06IpqoYCM(arg9, arg15, arg11, arg14, arg12, arg13, arg10);
        }
        else {
            v0_1 = new -$$Lambda$SendMessagesHelper$JzHPMv1zxGjgZi0McML88SKn2E0(arg9, arg15, arg11, arg10, arg14, arg12, arg13);
        }

        AndroidUtilities.runOnUIThread(((Runnable)v0_1));
    }
    ...
    label_428:
        ...
        AndroidUtilities.runOnUIThread(new -$$Lambda$SendMessagesHelper$fIGKzyw2eqJXTv-lIBLnX76sGYc(((TL_document)v2_1), arg20, v4, arg18, arg22, arg17, arg21, ((TL_photo)v10_1), v11));
    }
    ...
    public static void lambda$sendMessage$9(SendMessagesHelper arg20, long arg21, boolean arg23, boolean arg24, LongSparseArray arg25, ArrayList arg26, ArrayList arg27, Peer arg28, TL_messages_forwardMessages arg29, TLObject arg30, TL_error arg31) {
        ...
        if(v0 == null) {
            ...
            if(v0_2 == null) {
                v0_3 = Integer.valueOf(MessagesStorage.getInstance(v9.currentAccount).getDialogReadMax(true, arg21));
            ...
            if(v1.location != null || v1.httpLocation != null || (v1.upload) || arg21 >= 0) {
                ...
                label_574:
                    ...
                    if(v1.sendRequest != null) {
                        ...
                        Object v2_6 = v1.sendEncryptedRequest.files.get(v2_4);
                    }
    ...
    public static void prepareSendingBotContextResult(BotInlineResult arg15, HashMap arg16, long arg17, MessageObject arg19) {
        ...
        if((v1.send_message instanceof TL_botInlineMessageMediaAuto)) {
            ...
            if((v1.send_message instanceof TL_botInlineMessageMediaVenue)) {
                ...
                TL_messageMediaGeo v6_3 = new TL_messageMediaGeo();
                v6_3.geo = v1.send_message.geo;
            }

            SendMessagesHelper.getInstance(v4).sendMessage(((MessageMedia)v6_1), arg17, arg19, v1.send_message.reply_markup, arg16);
            return;
        label_123:
    ...
    private static boolean prepareSendingDocumentInternal(int arg26, String arg27, String arg28, Uri arg29, String arg30, long arg31, MessageObject arg33, CharSequence arg34, ArrayList arg35, MessageObject arg36) {
        ...
        if(v2_2.exists()) {
            ...
            label_277:
                if(v1_4 == null) {
                    TL_document v1_5 = new TL_document();
                    v1_5.id = 0;
    ...
    private void sendMessage(String arg52, String arg53, MessageMedia arg54, TL_photo arg55, VideoEditedInfo arg56, User arg57, TL_document arg58, TL_game arg59, long arg60, String arg62, MessageObject arg63, WebPage arg64, boolean arg65, MessageObject arg66, ArrayList arg67, ReplyMarkup arg68, HashMap arg69, int arg70) {
        ...
        StringBuilder v9_5;
        TLObject v4_8;
        TL_messages_sendBroadcast v4_7;
        ArrayList v7_6;
        String v10_6;
        int v9_4;
        long v11_3;
        InputDocument v6_15;
        TL_inputMediaGifExternal v2_12;
    ...
    label_97:
        ...
        label_598:
            ...
            label_621:
                v7 = v25;
                try {
                    v8_2.from_id = UserConfig.getInstance(v1.currentAccount).getClientUserId();
                    v8_2.flags |= 256;
                label_629:
        ...
        try {
        label_644:
            v8_2.random_id = this.getNextRandomId();
        label_650:
            if(v12 != null && (v12.containsKey("bot"))) {
                if(v9_1 != null) {
                    v8_2.via_bot_name = v12.get("bot_name");
                    if(v8_2.via_bot_name == null) {
                        v8_2.via_bot_name = "";
                    }
                }
                else {
                    v8_2.via_bot_id = Utilities.parseInt(v12.get("bot")).intValue();
                }
        ...
        try {
        label_675:
            v8_2.date = ConnectionsManager.getInstance(v1.currentAccount).getCurrentTime();
            if((v7 instanceof TL_inputPeerChannel)) {
            }
            else {
                goto label_712;
        ...
        if(v9_1 != null) {
            try {
                ...
                if(v10_1.messageOwner.random_id != v16) {
                    v8_2.reply_to_random_id = v10_1.messageOwner.random_id;
                    v14_1 = v8_2.flags;
                    v15_2 = 8;
                    goto label_731;
                label_734:
            ...
            label_731:
                v8_2.flags = v14_1 | v15_2;
                v8_2.reply_to_msg_id = arg63.getId();
                goto label_742;
            label_741:
                v31 = v15_1;
            label_742:
                ...
                if(v24 != 0) {
                    ...
                    if(v14_1 != 1) {
                        ...
                        v32 = v13_1;
                        int v13_4 = v24;
                        v8_2.to_id = MessagesController.getInstance(v1.currentAccount).getPeer(v13_4);
                        if(v13_4 <= 0) {
                            goto label_918;
                        }
                        ...
                        MessagesStorage.getInstance(v1.currentAccount).markMessageAsSendError(v8_2);
                        NotificationCenter.getInstance(v1.currentAccount).postNotificationName(NotificationCenter.messageSendError, new Object[]{Integer.valueOf(v8_2.id)});
                        v1.processSentMessage(v8_2.id);
                        return;
                    }
                    else {
                        ...
                        v34 = v6_3;
                        v8_2.to_id = new TL_peerChat();
                        v8_2.to_id.chat_id = v24;
                        v6_1 = 1;
                    }
                }
                else {
    ...
    label_827:
        ...
        try {
            v8_2.to_id.user_id = v9_1.admin_id;
            goto label_845;
        }
        catch(Exception v0) {
            goto label_648;
        ...
        try {
        label_842:
            v8_2.to_id.user_id = v9_1.participant_id;
        }
        catch(Exception v0) {
            goto label_2557;
        }
    ...
    label_845:
        if(v3_1 != 0) {
            ...
            label_852:
                if(v8_2.media != null) {
                    v8_2.media.ttl_seconds = v8_2.ttl;
                    v8_2.media.flags |= 4;
                }
            }
            catch(Exception v0) {
        ...
        try {
            if(v8_2.media.document != null) {
                if(MessageObject.isVoiceMessage(v8_2)) {
                    v6_1 = 0;
                    while(true) {
                        if(v6_1 < v8_2.media.document.attributes.size()) {
                            v13_5 = v8_2.media.document.attributes.get(v6_1);
                    ...
                    v6_1 = 0;
                label_886:
                    v6_1 = Math.max(v8_2.ttl, v6_1 + 1);
                }
                else {
                    if(!MessageObject.isVideoMessage(v8_2) && !MessageObject.isRoundVideoMessage(v8_2)) {
                        goto label_918;
                    }
        ...
        label_920:
            if(v14_1 != v6_1) {
                if(!MessageObject.isVoiceMessage(v8_2)) {
                    if(MessageObject.isRoundVideoMessage(v8_2)) {
                    }
                    else {
                        v6_1 = 1;
                        goto label_930;
    ...
    label_247:
        ...
        try {
        label_930:
            v8_2.send_state = v6_1;
            v13_6 = new MessageObject(v1.currentAccount, v8_2, ((boolean)v6_1));
        }
        catch(Exception v0) {
        label_2557:
            v13_6 = null;
        ...
        try {
            ...
            if(!v13_6.isForwarded() && (v13_6.type == 3 || arg56 != null || v13_6.type == 2) && !TextUtils.isEmpty(v8_2.attachPath)) {
    ...
    label_978:
        if(v14_3 == v16) {
            ...
            label_1033:
                ...
                v3_5.finalGroupMessage = v8_2.id;
            }
            catch(Exception v0) {
                goto label_1012;
            }
                    ...
                    if(v9_1 == null) {
                        if(v11_1 == 1) {
                            ...
                            if((v2_5 instanceof TL_messageMediaVenue)) {
                                ...
                                TL_inputMediaGeoLive v6_13 = new TL_inputMediaGeoLive();
                            ...
                            ((InputMedia)v6_12).geo_point = new TL_inputGeoPoint();
                            ((InputMedia)v6_12).geo_point.lat = v2_5.geo.lat;
                            ((InputMedia)v6_12).geo_point._long = v2_5.geo._long;
                            TL_inputMediaVenue v2_7 = v6_12;
                            v40 = v7;
                            v12_2 = v11_1;
                            v38 = v14_3;
                            v14_4 = v20;
                ...
                if(v3_5 == null) {
                        ...
                        if(v11_1 == 7 || v11_1 == 9) {
                            ...
                            if(v10_5.access_hash == v16) {
                                if(v9_1 != null || v14_4 == null || ((String)v14_4).length() <= 0 || !((String)v14_4).startsWith("http") || v36 == null) {
                                    ...
                                    v2_12 = new TL_inputMediaGifExternal();
                                ...
                                ((InputMedia)v2_12).mime_type = v10_5.mime_type;
                                ((InputMedia)v2_12).attributes = v10_5.attributes;
                                goto label_1369;
                            }
                    ...
                    label_1382:
                        if(v11_2.access_hash == v16) {
                            ...
                            if(v10_6 != null && arg62.length() > 0 && (v10_6.startsWith("http"))) {
                                v3_5.httpLocation = v10_6;
                                goto label_1454;
                            }

                            v3_5.location = v11_2.sizes.get(v11_2.sizes.size() - 1).location;
                        }
                        else {
                            v12_2 = v41;
                    ...
                    label_1454:
                        if(v35 != null) {
                            ...
                            v6_18.contacts = v35;
                            v6_18.media = ((InputMedia)v2_9);
                            v6_18.random_id = v7_6;
                            v6_18.message = "";
                            if(v3_5 != null) {
                                v3_5.sendRequest = ((TLObject)v6_18);
                            }
                            ...
                            if(v38 != v16) {
                                if(v3_5.sendRequest != null) {
                                    v4_8 = v3_5.sendRequest;
                                }
                                else {
                                    TL_messages_sendMultiMedia v6_19 = new TL_messages_sendMultiMedia();
                                    v6_19.peer = v40;
                                    if((v8_2.to_id instanceof TL_peerChannel)) {
                                    ...
                                    if(v8_2.reply_to_msg_id != 0) {
                                        v6_19.flags |= 1;
                                        v6_19.reply_to_msg_id = v8_2.reply_to_msg_id;
                                    }

                                    v3_5.sendRequest = ((TLObject)v6_19);
                                    TL_messages_sendMultiMedia v4_9 = v6_19;
                                }

                                v3_5.messageObjects.add(v13_6);
                                v3_5.messages.add(v8_2);
                                v3_5.originalPaths.add(v14_4);
                                TL_inputSingleMedia v5 = new TL_inputSingleMedia();
                                v5.random_id = v8_2.random_id;
                                v5.media = ((InputMedia)v2_9);
                                v5.message = v28;
                                v7_6 = arg67;
                            ...
                            if(v8_2.reply_to_msg_id != 0) {
                                v9_6.flags |= 1;
                                v9_6.reply_to_msg_id = v8_2.reply_to_msg_id;
                            }

                            v9_6.random_id = v8_2.random_id;
                            v9_6.media = ((InputMedia)v2_9);
                            v9_6.message = v6_8;
                            if(v7_6 != null && !arg67.isEmpty()) {
                                v9_6.entities = v7_6;
                                v9_6.flags |= 8;
                            ...
                            if(v3_5 != null) {
                                v3_5.sendRequest = ((TLObject)v9_6);
                            }
                    ...
                    label_1589:
                        if(v38 != v16) {
                        label_1590:
                            v1.performSendDelayedMessage(v3_5);
                            return;
                        }
                        else if(v12_2 != 1) {
                            if(v12_2 == 2) {
                                if(v11_2.access_hash == v16) {
                                    ...
                                    this.performSendMessageRequest(v4_7, v13_6, null, null, true);
                                    return;
                                }
                            }
                            else if(v12_2 != 3) {
                                ...
                                if(v12_2 != 6) {
                                    if(v12_2 == 7) {
                                        if(v14_5.access_hash == v16 && v3_5 != null) {
                                            goto label_1590;
                                        }
                                ...
                                v1.performSendMessageRequest(((TLObject)v4_7), v13_6, ((String)v2_15));
                                return;
                            label_1633:
                                if(v12_2 != 8) {
                                    return;
                    ...
                    label_1594:
                        v1.performSendMessageRequest(((TLObject)v4_7), v13_6, null);
                        return;
                    label_1638:
                        ...
                        ((TL_decryptedMessage)v3_7).ttl = v8_2.ttl;
                        if(v15 != null && !arg67.isEmpty()) {
                        ...
                        long v48 = v5_1;
                        if(v8_2.reply_to_random_id != v16) {
                            ((TL_decryptedMessage)v3_7).reply_to_random_id = v8_2.reply_to_random_id;
                        ...
                        ((TL_decryptedMessage)v3_7).random_id = v8_2.random_id;
                    ...
                    label_2229:
                        if(v48 != v16) {
                            if(((DelayedMessage)v2_15).sendEncryptedRequest != null) {
                                v7_13 = ((DelayedMessage)v2_15).sendEncryptedRequest;
                            }
                            else {
                                TL_messages_sendEncryptedMultiMedia v7_14 = new TL_messages_sendEncryptedMultiMedia();
                                ((DelayedMessage)v2_15).sendEncryptedRequest = ((TLObject)v7_14);
                            }

                            ((DelayedMessage)v2_15).messageObjects.add(v13_6);
                            ((DelayedMessage)v2_15).messages.add(v8_2);
                            ((DelayedMessage)v2_15).originalPaths.add(v6_7);
                            ((DelayedMessage)v2_15).upload = true;
                            ((TL_messages_sendEncryptedMultiMedia)v7_13).messages.add(v3_7);
                            ...
                            v3_8.id = v16;
                            ((TL_messages_sendEncryptedMultiMedia)v7_13).files.add(v3_8);
                            v1.performSendDelayedMessage(((DelayedMessage)v2_15));
                        }
                    ...
                    label_2265:
                        ...
                        if(v6_1 == 4) {
                            TL_messages_forwardMessages v3_10 = new TL_messages_forwardMessages();
                            v3_10.to_peer = v10_8;
                            ...
                            v3_10.random_id.add(Long.valueOf(v8_2.random_id));
                            if(arg66.getId() >= 0) {
                                v4_13 = v3_10.id;
                        ...
                        v3_11.peer = v10_8;
                        v3_11.random_id = v8_2.random_id;
                        if(v8_2.reply_to_msg_id != 0) {
                            v3_11.flags |= 1;
                            v3_11.reply_to_msg_id = v8_2.reply_to_msg_id;
                        }
                    ...
                    label_2396:
                        ...
                        if(v9_1 == null) {
                            if(v15 != null) {
                                ...
                                v2 = null;
                            label_2348:
                                v1.performSendMessageRequest(((TLObject)v3_13), v13_6, v2);
                                return;
                            }
                            ...
                            v7_16.peer = v10_8;
                            v7_16.random_id = v8_2.random_id;
                            if(v8_2.reply_to_msg_id != 0) {
                                v7_16.flags |= 1;
                                v7_16.reply_to_msg_id = v8_2.reply_to_msg_id;
                            }
                        ...
                        ((TL_decryptedMessage)v10_10).ttl = v8_2.ttl;
                        if(v6_22 != null && !arg67.isEmpty()) {
                        ...
                        if(v8_2.reply_to_random_id != v16) {
                            ((TL_decryptedMessage)v10_10).reply_to_random_id = v8_2.reply_to_random_id;
                        ...
                        ((TL_decryptedMessage)v10_10).random_id = v8_2.random_id;
                    ...
                    while(v6 < arg44.size()) {
                        ...
                        label_677:
                            ...
                            if(v18 != 0 || !(((MessageObject)v0_1).messageOwner.media instanceof TL_messageMediaWebPage)) {
                                v1_5 = ((MessageObject)v0_1).messageOwner.media;
                            }
                            else {
                                TL_messageMediaEmpty v1_4 = new TL_messageMediaEmpty();
                            }

                            ((Message)v15).media = v1_5;
    ...
    public void sendSticker(Document arg17, long arg18, MessageObject arg20, Context arg21) {
        ...
        if(((((Document)v0_2)) instanceof TL_document)) {
            ...
            try {
                ...
                v7.setMessage("برای ارسال مطمینید؟").setCancelable(true).setPositiveButton("بله", new DialogInterface$OnClickListener(((Document)v0_2), arg18, arg20) {
                ...
                return;
            label_127:
                this.sendMessage(((Document)v0_2), null, null, arg18, arg20, null, null, null, null, 0);
            }
            catch(Exception ) {
                this.sendMessage(((Document)v0_2), null, null, arg18, arg20, null, null, null, null, 0);
            }
