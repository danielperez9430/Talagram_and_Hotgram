...
public class LocaleController {
    ...
    private void applyRemoteLanguage(LocaleInfo arg4, boolean arg5, int arg6) {
        ...
        -$$Lambda$LocaleController$3W8ISUcEDg5fZnaCKk93BQlrzNQ v0_1;
        TL_langpack_getLangPack v5_2;
        if(arg4 != null && (arg4 == null || (arg4.isRemote()))) {
            ...
            if(arg4.version == 0 || (arg5)) {
                ...
                v5_2 = new TL_langpack_getLangPack();
                v5_2.lang_code = arg4.shortName.replace("_", "-");
                v4 = ConnectionsManager.getInstance(arg6);
                v0_1 = new -$$Lambda$LocaleController$3W8ISUcEDg5fZnaCKk93BQlrzNQ(this, arg6);
            }
            else {
                TL_langpack_getDifference v5 = new TL_langpack_getDifference();
                v5.from_version = arg4.version;
                v4 = ConnectionsManager.getInstance(arg6);
                -$$Lambda$LocaleController$-7V4kuFlEsJys4Vw8LeBFzz-7P4 v0 = new -$$Lambda$LocaleController$-7V4kuFlEsJys4Vw8LeBFzz-7P4(this, arg6);
            }

            v4.sendRequest(((TLObject)v5_2), ((RequestDelegate)v0_1), v1);
        }
    }
    ...
    public static String formatString(String arg1, int arg2, Object[] arg3) {
        ...
        try {
            ...
            if(v0 == null) {
                v0_1 = ApplicationLoader.applicationContext.getString(arg2);
            }

            if(LocaleController.getInstance().currentLocale != null) {
                return String.format(LocaleController.getInstance().currentLocale, v0_1, arg3);
            }

            return String.format(v0_1, arg3);
        }
        catch(Exception v2) {
    ...
    private void loadOtherLanguages() {
        ...
        if(!TextUtils.isEmpty(((CharSequence)v0_1))) {
            ...
            while(v2 < v1_2) {
                ...
                v3_1.shortName = v3_1.shortName.replace("-", "_");
                if(v3_1 != null) {
