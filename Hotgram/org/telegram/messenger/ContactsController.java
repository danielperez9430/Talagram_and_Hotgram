    ...
    private void applyContactsUpdates(ArrayList arg11, ConcurrentHashMap arg12, ArrayList arg13, ArrayList arg14) {
        ...
        while(true) {
            ...
            if(v2_1 < arg13.size()) {
                ...
                if(v6 == null) {
                    User v6_1 = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(((TL_contact)v4).user_id));
                }
                else {
                    MessagesController.getInstance(this.currentAccount).putUser(((User)v6), true);
                }

                if(v6 == null || (TextUtils.isEmpty(((User)v6).phone))) {
                    v3_1 = 1;
                }
                else {
                    v4 = this.contactsBookSPhones.get(((User)v6).phone);
                    if(v4 != null) {
                        int v7 = ((Contact)v4).shortPhones.indexOf(((User)v6).phone);
                        if(v7 != v5) {
        ...
        while(v0 < arg14.size()) {
            ...
            if(v4 == null) {
                User v4_1 = MessagesController.getInstance(this.currentAccount).getUser(((Integer)v2));
            }
            else {
            ...
            else if(!TextUtils.isEmpty(((User)v4).phone)) {
                v2 = this.contactsBookSPhones.get(((User)v4).phone);
                if(v2 != null) {
                    int v8 = ((Contact)v2).shortPhones.indexOf(((User)v4).phone);
                    if(v8 != v5) {
            ...
            while(v4.moveToNext()) {
                ...
                if(TextUtils.isEmpty(((CharSequence)v7))) {
                    ...
                    if(TextUtils.isEmpty(((CharSequence)v7))) {
                        ...
                        ((Contact)v12_1).shortPhones.add(v2_2);
                        ((Contact)v12_1).phones.add(v7);
                        ((Contact)v12_1).phoneDeleted.add(Integer.valueOf(0));
                        v0_2 = 2131625748;
                        if(v13_1 == 0) {
                            v7 = v4.getString(3);
                            ArrayList v3_1 = ((Contact)v12_1).phoneTypes;
                            if(v7 != null) {
                            }
                            else {
                            ...
                            if(v13_1 == 1) {
                                v0_4 = ((Contact)v12_1).phoneTypes;
                                v3_2 = LocaleController.getString("PhoneHome", 2131625746);
                            }
                            else if(v13_1 == 2) {
                                ((Contact)v12_1).phoneTypes.add(LocaleController.getString("PhoneMobile", v0_2));
                                goto label_198;
                            }
                            else if(v13_1 == 3) {
                                v0_4 = ((Contact)v12_1).phoneTypes;
