...
public class MessageObject {
        ...
        if((v0 instanceof TL_messageService)) {
            if(v0.action != null) {
                ...
                label_103:
                    ...
                    if(this.isOut()) {
                        v0_2 = v6.replaceWithLink(LocaleController.getString("ActionYouKickUser", 2131624005), "un2", ((TLObject)v1_2));
                        goto label_71;
                    }
                    ...
                    if(v0.action.user_id == UserConfig.getInstance(v6.currentAccount).getClientUserId()) {
                        ...
                        v6.messageText = v6.replaceWithLink(LocaleController.getString("ActionKickUser", 2131623977), "un2", ((TLObject)v1_2));
                        v0_2 = v6.messageText;
                    }
            ...
            label_149:
                if((v0.action instanceof TL_messageActionChatAddUser)) {
                    ...
                    label_352:
                        ...
                        label_469:
                            v2_5 = (((User)v2_4)) != null ? UserObject.getFirstName(((User)v2_4)) : "";
                            v5_1 = new Object[4];
                            v5_1[0] = v2_5;
                            v5_1[1] = v1_4;
                    ...
                    label_598:
                        if((v0.action instanceof TL_messageActionPinMessage)) {
                            ...
                            v6.generatePinMessageText(((User)v15), ((Chat)v0_4));
                            goto label_296;
                        }
            ...
            label_863:
                v5_1 = new Object[v11];
                v5_1[0] = UserObject.getFirstName(((User)v0_4));
    ...
    public MessageObject(int arg26, TL_channelAdminLogEvent arg27, ArrayList arg28, HashMap arg29, Chat arg30, int[] arg31) {
        ...
        label_90:
            v7_6 = v0.replaceWithLink(v7_6, "un1", v5_1);
            goto label_92;
        label_214:
            char v10_1 = ' ';
            char v15 = '\n';
            ...
            label_658:
                CharSequence v6_7 = v0.replaceWithLink(LocaleController.getString(v6_1, v7_1), "un1", v5_1);
                goto label_661;
            label_1058:
        ...
        label_661:
            v0.messageText = ((CharSequence)v6_1);
        label_1066:
            v6_3 = null;
        }
    ...
    label_1067:
        ...
        if(v1.action.message != null && !(v1.action.message instanceof TL_messageEmpty)) {
            v6_9 = v1.action.message;
        }

        if((((TL_message)v6_9)) != null) {
            v6_9.out = false;
            v10 = arg31[0];
            arg31[0] = v10 + 1;
            v6_9.id = v10;
            v6_9.reply_to_msg_id = 0;
            v6_9.flags &= -32769;
            if(v3.megagroup) {
                v6_9.flags |= v8;
            }

            MessageObject v3_1 = new MessageObject(arg26, ((TL_message)v6_9), null, null, true, v0.eventId);
            ...
            if(((MessageEntity)v10).length > 0 && ((MessageEntity)v10).offset >= 0) {
                if(((MessageEntity)v10).offset >= arg14.length()) {
                    ...
                    if((v10 instanceof TL_messageEntityBold)) {
                            ...
                            if((v10 instanceof TL_messageEntityPre)) {
                                ...
                                if(!arg20) {
                                    ...
                                    if((v10 instanceof TL_messageEntityBotCommand)) {
                                        URLSpanBotCommand v11_2 = new URLSpanBotCommand(v2_2, v6);
                                    }
                                    else {
                                        if(!(v10 instanceof TL_messageEntityHashtag) && (!arg18 || !(v10 instanceof TL_messageEntityMention)) && !(v10 instanceof TL_messageEntityCashtag)) {
                                            if((v10 instanceof TL_messageEntityEmail)) {
                                                ...
                                                v12_1.append("mailto:");
                                                v12_1.append(v2_2);
                                                v11_3 = new URLSpanReplacement(v12_1.toString());
                                                goto label_154;
                                            }
                                ...
                                label_154:
                                    ((Spannable)v1).setSpan(v11_3, ((MessageEntity)v10).offset, ((MessageEntity)v10).offset + ((MessageEntity)v10).length, v5);
                                }
                                else {
                                }
                        ...
                        v2_5 = new URLSpanMono(v1, ((MessageEntity)v10).offset, ((MessageEntity)v10).offset + ((MessageEntity)v10).length, v6);
                    }

                label_97:
                    ((Spannable)v1).setSpan(v2_5, ((MessageEntity)v10).offset, ((MessageEntity)v10).offset + ((MessageEntity)v10).length, v5);
                }
            }
        ...
        try {
            ...
            while(v0.find()) {
                ...
                if(arg7.charAt(v1) != v5) {
                    v3_2 = new URLSpanNoUnderline(arg7.subSequence(v1, v2).toString());
                }
                else if(arg8) {
                    v3_1 = new URLSpanBotCommand(arg7.subSequence(v1, v2).toString(), ((int)arg6));
                }

                if((((URLSpanBotCommand)v3_2)) == null) {
                    continue;
                }

                arg7.setSpan(v3_2, v1, v2, 0);
            }
        }
        catch(Exception v6) {
    ...
    label_19:
        ...
        label_219:
            v8_1 = this.replaceWithLink(((CharSequence)v0), v1_1, ((TLObject)v8));
        }
            ...
            if((this.replyMessageObject.messageOwner.media instanceof TL_messageMediaGame)) {
                ...
                this.messageText = this.replaceWithLink(((CharSequence)v0), v1_1, ((TLObject)v8));
                ...
                if(this.replyMessageObject.messageText != null && this.replyMessageObject.messageText.length() > 0) {
                    ...
                    v0 = LocaleController.formatString("ActionPinnedText", 2131623993, new Object[]{Emoji.replaceEmoji(v0_1, Theme.chat_msgTextPaint.getFontMetricsInt(), AndroidUtilities.dp(v2), false)});
                    v1_1 = "un1";
                    if(arg8 == null) {
                        goto label_218;
                    }
        ...
        for(v1 = 0; v1 < this.messageOwner.reply_markup.rows.size(); ++v1) {
            ...
            while(v4 < v3) {
                ...
                if(!(v6 instanceof TL_keyboardButtonBuy) || (this.messageOwner.media.flags & 4) == 0) {
                    v6_2 = Emoji.replaceEmoji(((KeyboardButton)v6).text, Theme.chat_msgBotButtonPaint.getFontMetricsInt(), AndroidUtilities.dp(15f), false);
                }
                else {
                    String v6_1 = LocaleController.getString("PaymentReceipt", 2131625709);
                }

                StaticLayout v6_3 = new StaticLayout(((String)v6_2), Theme.chat_msgBotButtonPaint, AndroidUtilities.dp(2000f), Layout$Alignment.ALIGN_NORMAL, 1f, 0f, false);
