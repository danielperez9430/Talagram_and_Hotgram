...
public class AndroidUtilities {
    ...
    label_27:
        ...
        ((double[])v12)[1] = Math.min(1, ((double[])v12)[1] + 0.05 + (1 - ((double[])v12)[1]) * 0.1);
        ((double[])v12)[v0] = Math.max(0, ((double[])v12)[v0] * 0.65);
    ...
    public static boolean handleProxyIntent(Activity arg12, Intent arg13) {
        ...
        try {
            ...
            label_114:
                ...
                AndroidUtilities.showProxyAlert(arg12, ((String)v6_1), ((String)v7_1), v8, v9, v13_1);
                return 1;
            }
    ...
    public static void openForView(MessageObject arg8, Activity arg9) {
        ...
        label_55:
            ...
            if(Build$VERSION.SDK_INT >= v2_1) {
                v0_1 = FileProvider.a(((Context)arg9), "ir.hotgram.mobile.android.provider", v1);
                if(v8 == null) {
                    goto label_96;
                }
            ...
            if(v8 != null) {
                try {
                    ...
                    Uri v8_2 = Build$VERSION.SDK_INT >= v2_1 ? FileProvider.a(((Context)arg9), "ir.hotgram.mobile.android.provider", v1) : Uri.fromFile(v1);
        ...
        if(arg8 != null && arg9 != null) {
            ...
            label_36:
                ...
                if(Build$VERSION.SDK_INT >= v0_1) {
                    v8_1 = FileProvider.a(((Context)arg9), "ir.hotgram.mobile.android.provider", v2);
                    if(v7 == null) {
                        goto label_44;
                    }
                ...
                if(v7 != null) {
                    try {
                        ...
                        Uri v0_2 = Build$VERSION.SDK_INT >= v0_1 ? FileProvider.a(((Context)arg9), "ir.hotgram.mobile.android.provider", v2) : Uri.fromFile(v2);
    ...
    public static void showProxyAlert(Activity arg19, String arg20, String arg21, String arg22, String arg23, String arg24) {
        ...
        for(v5_2 = 0; v5_2 < v9; ++v5_2) {
            ...
            if(TextUtils.isEmpty(((CharSequence)v12_2))) {
                ...
                v15.setTextAndValue(v12_2, v14_1, true);
