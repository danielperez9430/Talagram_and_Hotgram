...
public class NotificationsController {
    ...
    @SuppressLint(value={"InlinedApi"}) private void showExtraNotifications(d arg66, boolean arg67, String arg68) {
        ...
        label_349:
            ...
            int v43 = v12;
            v7_5.a(PendingIntent.getBroadcast(ApplicationLoader.applicationContext, v3_2.intValue(), v9_4, 134217728));
            if((v34) && !v32 || (!v1_2 || (SharedConfig.isWaitingForPasscodeEnter))) {
                ...
                v44 = v1_2;
                v7_5.a(PendingIntent.getBroadcast(ApplicationLoader.applicationContext, v3_2.intValue(), v4_6, 134217728), new android.support.v4.app.ac$a("extra_voice_reply").a(LocaleController.getString("Reply", 2131625860)).a());
                ...
                v1_4 = PendingIntent.getBroadcast(ApplicationLoader.applicationContext, v3_2.intValue(), v1_3, 134217728);
            ...
            if(v1_5 == null) {
                v4 = 0;
                Integer v1_6 = Integer.valueOf(0);
            }
            else {
                v4 = 0;
            }
            ...
            v12_2[v4] = v13_2;
            v12_2[1] = LocaleController.formatPluralString("NewMessages", Math.max(((Integer)v1_5).intValue(), ((ArrayList)v39).size()));
            ...
            label_573:
                ...
                if(((MessageObject)v13_3).isVoice()) {
                    ...
                    if(Build$VERSION.SDK_INT >= 24) {
                        try {
                            v8_4 = FileProvider.a(ApplicationLoader.applicationContext, "ir.hotgram.mobile.android.provider", v3_6);
                        }
                        catch(Exception ) {
                            v8_4 = null;
                        }
