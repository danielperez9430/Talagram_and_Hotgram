        ...
        if(!this.transitionAnimationInProgress) {
            if(this.startedTracking) {
                ...
                while(true) {
                    ...
                    if(v3 == 0) {
                        BaseFragment v5_1 = this.getLastFragment();
                        goto label_41;
                    }
                    else {
                    ...
                    label_41:
                        if((((BaseFragment)v5_2)) == null) {
                            goto label_98;
                        }

                        this.themeAnimatorDescriptions[v3] = ((BaseFragment)v5_2).getThemeDescriptions();
    ...
    public boolean presentFragment(BaseFragment arg17, boolean arg18, boolean arg19, boolean arg20, boolean arg21) {
        ...
        if(!this.checkTransitionAnimation() && (v6.delegate == null || !arg20 || (v6.delegate.needPresentFragment(v7, v3, v0, v6))) && (arg17.onFragmentCreate())) {
            ...
            if(!v6.fragmentsStack.isEmpty()) {
                v4 = v6.fragmentsStack.get(v6.fragmentsStack.size() - 1);
            }
            else {
                BaseFragment v4_1 = null;
            }
            ...
            if(v0_1 == 0) {
                v6.presentFragmentInternalRemoveOld(v3, ((BaseFragment)v4));
            ...
            if(v0_1 != 0 || (v8)) {
                ...
                v6.transitionAnimationStartTime = System.currentTimeMillis();
                v6.transitionAnimationInProgress = true;
                v6.onOpenAnimationEndRunnable = new -$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y(this, arg21, arg18, ((BaseFragment)v4), arg17);
                v7.onTransitionAnimationStart(true, false);
