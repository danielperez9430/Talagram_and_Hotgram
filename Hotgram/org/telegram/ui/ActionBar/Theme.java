...
public class Theme {
    ...
    label_3051:
        ...
        Theme.applyTheme(v2, false, false, false);
    ...
    public static void applyChatServiceMessageColor() {
        ...
        if(v1 == null) {
            Integer v1_1 = Integer.valueOf(Theme.serviceSelectedMessageColor);
        }
    ...
    label_44:
        if(Theme.currentSelectedColor != ((Integer)v1).intValue()) {
            Theme.currentSelectedColor = ((Integer)v1).intValue();
            Theme.colorPressedFilter = new PorterDuffColorFilter(((Integer)v1).intValue(), PorterDuff$Mode.MULTIPLY);
        }
    }
                ...
                if(arg5.equals("Blue")) {
                    ...
                    if(!AndroidUtilities.copyFile(arg4, v1)) {
                        ...
                        if(!arg6) {
                            ...
                            if(v4_3 != 0) {
                                Theme.themes.add(v5_1);
                                Theme.themesDict.put(((ThemeInfo)v5_1).name, v5_1);
                                Theme.otherThemes.add(v5_1);
                                Theme.sortThemes();
                                Theme.saveOtherThemes();
                            }
                        }
                        ...
                        Theme.applyTheme(((ThemeInfo)v5_1), (((int)arg6)) ^ 1, true, false);
                        return ((ThemeInfo)v5_1);
                    }
                }
            }
        }
    ...
    public static Drawable createSelectorDrawable(int arg6, int arg7) {
        ...
        if(Build$VERSION.SDK_INT >= 21) {
            ...
            if(arg7 == 1) {
                ...
                org.telegram.ui.ActionBar.Theme$6 v7 = new Drawable() {
                    public void draw(Canvas arg5) {
            ...
            return new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{arg6}), v3, v7_2);
        }
