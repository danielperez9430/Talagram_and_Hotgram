...
public class SlsVoIPActivity extends e implements d, NotificationCenterDelegate, StateListener {
    ...
    private View createContentView() {
        ...
        if(LocaleController.isRTL) {
            ...
            SignalBarsDrawable v3_1 = v6.signalBarsDrawable;
        }

        v0_1.setCompoundDrawables(((Drawable)v9), ((Drawable)v10), v3, ((Drawable)v10));
                                    ...
                                    if(this.val$state == v2) {
                                        ...
                                        if(this.val$state == 4) {
                                            ...
                                            if(v0_2 == 1) {
                                                ...
                                                v3_1 = new Object[]{ContactsController.formatName(SlsVoIPActivity.this.user.first_name, SlsVoIPActivity.this.user.last_name)};
                                            label_207:
                                                SpannableStringBuilder v1_3 = AndroidUtilities.replaceTags(LocaleController.formatString(v1_2, v2, v3_1));
                                            }
                                            else if(v0_2 == v4) {
                                                v0_1 = SlsVoIPActivity.this;
                                            ...
                                            v0_1.showErrorDialog(((CharSequence)v1_2));
                                            goto label_322;
                                        label_245:
                                            if(v0_2 == -3) {
                                                SlsVoIPActivity.this.finish();
    ...
    private void setEmojiExpanded(boolean arg17) {
        org.telegram.ui.SlsVoIPActivity$29 v2_2;
        float[] v6_1;
        float[] v7_1;
        AnimatorSet v1_2;
        SlsVoIPActivity v0 = this;
        ...
        if(v1) {
            ...
            v2_2 = new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator arg2) {
            ...
            v1_2.setInterpolator(CubicBezierInterpolator.DEFAULT);
            v0.emojiAnimator = v1_2;
            org.telegram.ui.SlsVoIPActivity$30 v2_4 = new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator arg2) {
                    SlsVoIPActivity.this.emojiAnimator = null;
                }
            };
        ...
        v1_2.addListener(((Animator$AnimatorListener)v2_2));
        v1_2.start();
    }
