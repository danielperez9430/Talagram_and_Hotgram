...
public class SharingLiveLocationCell extends FrameLayout {
    ...
    public void setDialog(SharingLocationInfo arg5) {
        ...
        if(v5 > 0) {
            ...
            label_44:
                TLObject v5_4 = ((TLObject)v0);
            }
        }

        this.avatarImageView.setImage(((TLObject)v5_2), v0, this.avatarDrawable);
    }
    ...
    public void setDialog(MessageObject arg9, Location arg10) {
        ...
        label_101:
            this.avatarImageView.setImage(v3_3, ((String)v2), this.avatarDrawable);
        }
