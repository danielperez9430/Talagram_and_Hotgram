...
public class h {
    a a;
    org.telegram.customization.i.c.a b;
    b c;
    HashMap d;

    public h(org.telegram.customization.i.c.a arg2) {
        super();
        this.d = new HashMap();
        this.b = arg2;
        this.a = new a();
    ...
    public void a(f arg3, long arg4, String arg6) {
        this.a(arg3, d.a, this.b.a(arg4, arg6));
    }

    protected void a(f arg2, d arg3, f.b arg4) {
        this.a(arg2, arg3, arg4, null);
    }

    protected void a(f arg11, d arg12, f.b arg13, Object arg14) {
        aa v7 = arg13.c();
        if(this.c != null) {
            ...
            label_30:
                ...
                arg13.a(new f.d(arg12, v7, arg14, arg11) {
                    public void a(f.b arg19, l arg20) {
                        org.telegram.customization.i.c.h$1 v0 = this;
                        v0.e.d.remove(arg19);
                        if(arg20.b()) {
                            Object v1 = arg20.c();
                            if(v0.e.c != null) {
