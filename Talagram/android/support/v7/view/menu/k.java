...
public class k extends c implements MenuItem {
    ...
    class android.support.v7.view.menu.k$b extends FrameLayout implements android.support.v7.view.c {
        final CollapsibleActionView a;

        android.support.v7.view.menu.k$b(View arg2) {
    ...
    k(Context arg1, android.support.v4.a.a.b arg2) {
        super(arg1, arg2);
    }
    ...
    public void a(boolean arg7) {
        try {
            ...
            this.c.invoke(this.b, Boolean.valueOf(arg7));
        }
        catch(Exception v7) {
    ...
    public View getActionView() {
        ...
        if((v0 instanceof android.support.v7.view.menu.k$b)) {
            v0 = ((android.support.v7.view.menu.k$b)v0).c();
        }
    ...
    public MenuItem setActionProvider(ActionProvider arg2) {
        ...
        ((android.support.v4.a.a.b)v0).a(v2_1);
        return this;
    }

    public MenuItem setActionView(int arg3) {
        this.b.setActionView(arg3);
        View v3 = this.b.getActionView();
        if((v3 instanceof CollapsibleActionView)) {
            this.b.setActionView(new android.support.v7.view.menu.k$b(v3));
        }
    ...
    public MenuItem setActionView(View arg2) {
        android.support.v7.view.menu.k$b v2;
        if((arg2 instanceof CollapsibleActionView)) {
            v2 = new android.support.v7.view.menu.k$b(arg2);
        }
    ...
    public MenuItem setOnActionExpandListener(MenuItem$OnActionExpandListener arg3) {
        ...
        ((android.support.v4.a.a.b)v0).setOnActionExpandListener(v1_1);
        return this;
    }
    ...
    public MenuItem setOnMenuItemClickListener(MenuItem$OnMenuItemClickListener arg3) {
        ...
        ((android.support.v4.a.a.b)v0).setOnMenuItemClickListener(((MenuItem$OnMenuItemClickListener)v1));
        return this;
    }
