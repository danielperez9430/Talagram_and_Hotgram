        ...
        public b a() {
            ...
            if(this.b != null) {
                ...
                if(this.g.isEmpty()) {
                    ...
                    Object[] v4_2 = this.g.toArray(new android.support.v7.d.b$b[this.g.size()]);
                }

                android.support.v7.d.a v1_1 = new android.support.v7.d.a(v2_1, v3, v4_1);
                if(v0 != this.b) {
                    v0.recycle();
                }
