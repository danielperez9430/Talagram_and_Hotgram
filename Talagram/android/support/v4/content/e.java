...
@Deprecated public abstract class e extends BroadcastReceiver {
    private static final String EXTRA_WAKE_LOCK_ID = "android.support.content.wakelockid";
    private static int mNextId;
    private static final SparseArray sActiveWakeLocks;

    static {
        e.sActiveWakeLocks = new SparseArray();
        e.mNextId = 1;
    }
    ...
    public static boolean completeWakefulIntent(Intent arg5) {
        ...
        SparseArray v0 = e.sActiveWakeLocks;
        __monitor_enter(v0);
        try {
            Object v1 = e.sActiveWakeLocks.get(v5);
            if(v1 != null) {
                ((PowerManager$WakeLock)v1).release();
                e.sActiveWakeLocks.remove(v5);
                __monitor_exit(v0);
                return 1;
            }
    ...
    public static ComponentName startWakefulService(Context arg5, Intent arg6) {
        ...
        try {
            ...
            v5_2.acquire(60000);
            e.sActiveWakeLocks.put(v1, v5_2);
            __monitor_exit(v0);
            return v6;
        label_36:
            __monitor_exit(v0);
