...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    public void setStickersSet(StickerSetCovered arg9, boolean arg10, boolean arg11) {
        org.telegram.ui.Cells.FeaturedStickerSetCell$4 v10_5;
        Animator[] v11_3;
        AnimatorSet v9_1;
        boolean v9;
        ...
        if(arg11) {
            ...
            if(LocaleController.isRTL) {
                ...
                org.telegram.ui.Cells.FeaturedStickerSetCell$2 v4_1 = v10;
            }
            ...
            v11.setCompoundDrawablesWithIntrinsicBounds(v4, ((Drawable)v3), v10_1, ((Drawable)v3));
        }
        else {
        ...
        if(v0 != 0) {
            ...
            if(v9) {
                if(!arg11) {
                    ...
                    v9_1 = this.currentAnimation;
                    org.telegram.ui.Cells.FeaturedStickerSetCell$3 v10_4 = new AnimatorListenerAdapter() {
                ...
                v9_1.playTogether(v11_3);
                v9_1 = this.currentAnimation;
                v10_5 = new AnimatorListenerAdapter() {
                    public void onAnimationCancel(Animator arg2) {
                        if(FeaturedStickerSetCell.this.currentAnimation != null && (FeaturedStickerSetCell.this.currentAnimation.equals(arg2))) {
                            FeaturedStickerSetCell.this.currentAnimation = null;
                        }
            ...
            v9_1.addListener(((Animator$AnimatorListener)v10_5));
