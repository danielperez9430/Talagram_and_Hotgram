...
public class UserCell extends FrameLayout {
    ...
    public void update(int arg12) {
        ...
        label_70:
            if(v5 != 0 || this.currentName != null || this.lastName == null || (arg12 & 1) == 0) {
                ...
                v12 = v0 != null ? UserObject.getUserName(((User)v0)) : ((Chat)v3_1).title;
    ...
    label_90:
        if(v0 != null) {
            ...
            this.avatarDrawable.setInfo(((Chat)v3_1));
        }
        else {
        ...
        if(this.currentName != null) {
            ...
            CharSequence v1_1 = this.currentName;
        }
        else {
            if(v0 != null) {
                if(v12 == null) {
