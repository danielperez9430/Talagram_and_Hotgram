...
public class SearchAdapterHelper {
    ...
    public void addHashtagsFromMessage(CharSequence arg9) {
        ...
        for(v2 = 0; v0.find(); v2 = 1) {
            ...
            if(v3_1 == null) {
                HashtagObject v3_2 = new HashtagObject();
                v3_2.hashtag = v2_1;
            ...
            ((HashtagObject)v3_1).date = ((int)(System.currentTimeMillis() / 1000));
            this.hashtags.add(0, v3_1);
        }
    ...
    public void queryServerSearch(String arg13, boolean arg14, boolean arg15, boolean arg16, boolean arg17, int arg18, boolean arg19) {
        TL_channelParticipantsBanned v9;
        ...
        if(arg13.length() <= 0 || v0 == 0) {
            ...
            if(arg19) {
                v9 = new TL_channelParticipantsBanned();
            }
            else {
                TL_channelParticipantsSearch v9_1 = new TL_channelParticipantsSearch();
            }

            v2.filter = ((ChannelParticipantsFilter)v9);
            v2.filter.q = v6;
            v2.limit = v5;
            v2.offset = 0;
