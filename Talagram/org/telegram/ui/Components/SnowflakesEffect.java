                ...
                if(Utilities.random.nextFloat() > 0.7f) {
                    ...
                    if(this.particles.size() < v0) {
                        ...
                        if(!this.freeParticles.isEmpty()) {
                            Object v5 = this.freeParticles.get(0);
                            this.freeParticles.remove(0);
                        }
                        else {
                            v5_1 = new Particle(this, null);
                        }
                        ...
                        v5_1.alpha = 0f;
                        v5_1.currentTime = 0f;
                        v5_1.scale = Utilities.random.nextFloat() * 1.2f;
                        v5_1.type = Utilities.random.nextInt(2);
                        v5_1.lifeTime = ((float)(Utilities.random.nextInt(v0) + 2000));
                        v5_1.velocity = Utilities.random.nextFloat() * 4f + v6;
                        this.particles.add(v5_1);
                    }
                }
