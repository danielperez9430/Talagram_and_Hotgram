                    ...
                    if(this.particles.size() + v0 < 150) {
                        ...
                        for(v4 = 0; v4 < v0; ++v4) {
                            ...
                            if(!this.freeParticles.isEmpty()) {
                                Object v8 = this.freeParticles.get(0);
                                this.freeParticles.remove(0);
                            }
                            else {
                                v8_1 = new Particle(this, null);
                            }
                            ...
                            v8_1.alpha = 1f;
                            v8_1.currentTime = 0f;
                            v8_1.scale = Math.max(1f, Utilities.random.nextFloat() * 1.5f);
                            v8_1.type = 0;
                            v8_1.lifeTime = ((float)(Utilities.random.nextInt(1000) + 1000));
                            v8_1.velocity = Utilities.random.nextFloat() * 4f + v6;
                            this.particles.add(v8_1);
                        }
                    }
                }
