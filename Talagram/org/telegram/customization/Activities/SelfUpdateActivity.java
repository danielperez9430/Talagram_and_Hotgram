...
public class SelfUpdateActivity extends Activity implements View$OnClickListener {
    ...
    public void a(Context arg8, String arg9) {
        ...
        if(v4_2 == 0) {
            try {
                ...
                v4_1.setFlags(v3);
                v4_1.setFlags(1);
                v4_1.setData(FileProvider.a(arg8, "org.ir.talaeii.provider", v0));
                this.startActivity(v4_1);
                v5_1 = -1;
            }
            catch(Exception v8) {
    ...
    public void onClick(View arg7) {
        ...
        try {
            b.c().a(new m("TRACKER_VIEW_ACTION").a("Download Clicked", Integer.valueOf(206)));
            goto label_19;
        }
        catch(Exception ) {
        label_19:
            if(this.a.getUpdate().isFromMarket()) {
                try {
                    ...
                    v7_2.setData(Uri.parse("bazaar://details?id=org.ir.talaeii"));
    ...
    protected void onCreate(Bundle arg5) {
        ...
        try {
            b.c().a(new m("TRACKER_VIEW_ACTION").a("UPDATE ACTIVITY SHOWN", Integer.valueOf(206)));
            goto label_12;
        }
        catch(Exception ) {
        label_12:
