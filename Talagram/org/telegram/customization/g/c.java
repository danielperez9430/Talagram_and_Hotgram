...
public class c implements d, ErrorListener, Listener {
            ...
            public Request b() {
                ...
                return new StringRequest(0, String.format(v0.toString(), this.b, Long.valueOf(this.c)), this.d, this.d) {
                    ...
                    public Map getHeaders() {
                        ...
                        ((Map)v0).put("X-SLS-Version", String.valueOf(206));
                        String v1 = "550205994";
                        String v2 = "-1";
                        if(v1.length() > 0) {
    ...
    public void c() {
        this.a(new a() {
            ...
            public Request b() {
                org.telegram.customization.g.c$4$1 v0 = new org.telegram.customization.g.b(0, String.format("v5/config?appId=%s&appVer=%s&apiVer=%s", String.valueOf(c.d(this.a).getResources().getInteger(2131361792)), String.valueOf(206), String.valueOf(12)), this.a, this.a, c.d(this.a), this.e()) {
                    public byte[] getBody() {
                        return super.getBody();
                    }
    ...
    private boolean k(String arg15) {
        ...
        if(v2 == null) {
            DefaultRetryPolicy v2_1 = new DefaultRetryPolicy(org.telegram.customization.g.f.a(this.g), 0, 1f);
        }

        ((Request)v1).setRetryPolicy(v2);
