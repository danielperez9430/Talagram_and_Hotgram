...
public class Emoji {
    ...
    public static void addRecentEmoji(String arg5) {
        ...
        Emoji.emojiUseHistory.put(arg5, Integer.valueOf(v0_1.intValue() + 1));
    }
    ...
    static int lambda$sortEmoji$1(String arg3, String arg4) {
        ...
        if(((Integer)v3).intValue() > v4_1.intValue()) {
            return -1;
        }
        ...
        if(!SharedConfig.useSystemEmoji && v1 != null) {
            if(arg24.length() == 0) {
                ...
                if((arg27) || !(v1 instanceof Spannable)) {
                    Spannable v0_1 = Spannable$Factory.getInstance().newSpannable(arg24.toString());
                }
                else {
                    v0 = v1;
                }
                    ...
                    if(v10 < v4) {
                        ...
                        label_145:
                            ...
                            if(v9 != 0) {
                                ...
                                if(v6_3 != null) {
                                    ((Spannable)v0).setSpan(new EmojiSpan(v6_3, v5_1, arg26, arg25), v13, v10 + v13, 33);
                                    ++v18;
                                    v5_1 = 0;
                                }
                                else {
