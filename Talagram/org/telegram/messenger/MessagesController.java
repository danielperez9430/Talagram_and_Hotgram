...
public class MessagesController implements NotificationCenterDelegate {
    ...
    private void completeReadTask(ReadTask arg6) {
        ...
        if(v0 != 0) {
            ...
            if((v1_1 instanceof TL_inputPeerChannel)) {
                ...
                TL_channels_readHistory v0_1 = v1_2;
            }
            else {
                v0_2 = new TL_messages_readHistory();
                v0_2.peer = v1_1;
                v0_2.max_id = arg6.maxId;
            }

            ConnectionsManager.getInstance(this.currentAccount).sendRequest(((TLObject)v0_2), new -$$Lambda$MessagesController$cukM8JCLNtumXeR2C2_0LmUkQq0(this));
        }
        else {
    ...
    public int createChat(String arg9, ArrayList arg10, String arg11, int arg12, BaseFragment arg13) {
        ...
        if(arg12 == 1) {
            ...
            v9_3.random_id = 0;
            ((TL_messageService)v9_2).flags |= 256;
    ...
    label_15:
        if(arg8 > 0) {
            ...
            if(!v5) {
                ...
                if((v10.creator) && (arg11)) {
                    TL_channels_deleteChannel v11 = new TL_channels_deleteChannel();
                ...
                v11_2 = new TL_channels_editBanned();
        ...
        label_67:
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(((TLObject)v11_2), new -$$Lambda$MessagesController$oKtWdTAN0dAt058skQlRH_zRN88(this, arg9, arg8, v5, v6), 64);
        }
        else {
    ...
    public static void lambda$addUserToChat$161(MessagesController arg7, boolean arg8, InputUser arg9, int arg10, BaseFragment arg11, TLObject arg12, boolean arg13, TLObject arg14, TL_error arg15) {
        ...
        if(arg15 != null) {
            com.crashlytics.android.a.b.c().a(new m("JOIN_ERROR").a("6.0.6", arg15.text));
    ...
    public static void lambda$null$184(MessagesController arg17, updates_ChannelDifference arg18, int arg19, Chat arg20, SparseArray arg21, int arg22, long arg23) {
        ...
        if(((v1 instanceof TL_updates_channelDifference)) || ((v1 instanceof TL_updates_channelDifferenceEmpty))) {
            if(!v1.new_messages.isEmpty()) {
                ...
                if(v13_1 == null) {
                    Integer v13_2 = Integer.valueOf(MessagesStorage.getInstance(v0.currentAccount).getDialogReadMax(true, v10));
                ...
                while(v14_1 < v1.new_messages.size()) {
                    ...
                    if(v3 == null || !v3.left) {
                        Object v8 = ((Message)v15).out ? v13_1 : v12_1;
    ...
    public static void lambda$processDialogsUpdate$117(MessagesController arg14, messages_Dialogs arg15) {
        ...
        label_110:
            ...
            label_136:
                ...
                arg14.dialogs_read_inbox_max.put(Long.valueOf(((TL_dialog)v5_1).id), Integer.valueOf(Math.max(v8_2.intValue(), ((TL_dialog)v5_1).read_inbox_max_id)));
                v8 = arg14.dialogs_read_outbox_max.get(Long.valueOf(((TL_dialog)v5_1).id));
                if(v8 == null) {
                    v8_2 = Integer.valueOf(0);
                }

                arg14.dialogs_read_outbox_max.put(Long.valueOf(((TL_dialog)v5_1).id), Integer.valueOf(Math.max(v8_2.intValue(), ((TL_dialog)v5_1).read_outbox_max_id)));
            }
        }
    ...
    public static void lambda$processLoadedDialogs$108(MessagesController arg22, int arg23, messages_Dialogs arg24, boolean arg25, int arg26, int arg27, boolean arg28, boolean arg29, ArrayList arg30) {
        ...
        label_297:
            if(((TL_dialog)v4).id == v14) {
                ...
                v13.dialogs_read_inbox_max.put(Long.valueOf(((TL_dialog)v4).id), Integer.valueOf(Math.max(((Integer)v9_2).intValue(), ((TL_dialog)v4).read_inbox_max_id)));
                v9_2 = v13.dialogs_read_outbox_max.get(Long.valueOf(((TL_dialog)v4).id));
                if(v9_2 == null) {
                    v9_3 = Integer.valueOf(0);
                }

                v13.dialogs_read_outbox_max.put(Long.valueOf(((TL_dialog)v4).id), Integer.valueOf(Math.max(((Integer)v9_2).intValue(), ((TL_dialog)v4).read_outbox_max_id)));
            }
                ...
                label_436:
                    if(!(((Message)v9_2).action instanceof TL_messageActionChatMigrateTo)) {
                        if((((Message)v9_2).action instanceof TL_messageActionChannelCreate)) {
                            ...
                            if(v12 == null) {
                                Integer v12_1 = Integer.valueOf(MessagesStorage.getInstance(v13.currentAccount).getDialogReadMax(((Message)v9_2).out, ((Message)v9_2).dialog_id));
                                v11_2.put(Long.valueOf(((Message)v9_2).dialog_id), v12_1);
                            }

                            boolean v1_3 = ((Integer)v12).intValue() < ((Message)v9_2).id ? true : false;
    ...
    label_54:
        ...
        if(!arg28) {
            v5 = arg24;
            Object v0_2 = v5.dialogs_read_inbox_max.get(Long.valueOf(arg26));
            if(v0_2 == null) {
                v0_3 = Integer.valueOf(MessagesStorage.getInstance(v5.currentAccount).getDialogReadMax(false, v8));
    ...
    public static void lambda$reloadDialogsReadValue$10(MessagesController arg8, TLObject arg9, TL_error arg10) {
        ...
        TL_updateReadChannelInbox v3_3;
        Integer v3_2;
        int v3;
        if(arg9 != null) {
            ...
            label_43:
                ...
                arg8.dialogs_read_inbox_max.put(Long.valueOf(((TL_dialog)v2).id), Integer.valueOf(Math.max(((TL_dialog)v2).read_inbox_max_id, v3_2.intValue())));
                if(v3_2.intValue() == 0) {
                    if(((TL_dialog)v2).peer.channel_id != 0) {
                        v3_3 = new TL_updateReadChannelInbox();
                        v3_3.channel_id = ((TL_dialog)v2).peer.channel_id;
                        v3_3.max_id = ((TL_dialog)v2).read_inbox_max_id;
                    }
                    else {
                        TL_updateReadHistoryInbox v3_4 = new TL_updateReadHistoryInbox();
                ...
                arg8.dialogs_read_outbox_max.put(Long.valueOf(((TL_dialog)v2).id), Integer.valueOf(Math.max(((TL_dialog)v2).read_outbox_max_id, v3_2.intValue())));
                if(v3_2.intValue() == 0) {
                    if(((TL_dialog)v2).peer.channel_id != 0) {
        ...
        if(this.loadingNotificationSettings == 0) {
            if(UserConfig.getInstance(this.currentAccount).notificationsSettingsLoaded) {
                ...
                for(v1 = 0; v1 < v0; ++v1) {
                    ...
                    if(v1 == 0) {
                        TL_inputNotifyChats v3 = new TL_inputNotifyChats();
                        goto label_16;
                    }
                    else if(v1 == 1) {
                        TL_inputNotifyUsers v3_1 = new TL_inputNotifyUsers();
                    label_16:
                        v2.peer = ((InputNotifyPeer)v3_1);
                    }
        ...
        if(v0 != 0) {
            if(v5 != 0) {
                if(v3 == 1) {
                    ...
                    if(v3_2 == null) {
                        Integer v3_3 = Integer.valueOf(0);
                    }

                    v8.dialogs_read_inbox_max.put(Long.valueOf(arg21), Integer.valueOf(Math.max(((Integer)v3_2).intValue(), v5)));
    ...
    private void processUpdatesQueue(int arg9, int arg10) {
        ...
        if(arg9 == 0) {
            ...
            -$$Lambda$MessagesController$zpaQhU1OxkqKk3fukxYvEw7gKt4 v3 = new -$$Lambda$MessagesController$zpaQhU1OxkqKk3fukxYvEw7gKt4(this);
            goto label_6;
        }
        else if(arg9 == 1) {
        ...
        label_6:
            Collections.sort(((List)v2), ((Comparator)v3_2));
        }
        else {
            v2 = null;
        }
    ...
    private void reloadMessages(ArrayList arg9, long arg10) {
        ...
        if(ChatObject.isChannel(v5)) {
            v0 = new TL_channels_getMessages();
            v0.channel = MessagesController.getInputChannel(v5);
            v0.id = v6;
        }
        else {
            TL_messages_getMessages v0_1 = new TL_messages_getMessages();
            v0_1.id = v6;
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(((TLObject)v0), new -$$Lambda$MessagesController$QhJGNGV6q9NodF06WsHicwFciYQ(this, arg10, v5, v6));
    }
        ...
        if(arg26) {
            ...
            label_192:
                ...
                label_231:
                    ...
                    v6.dialogs_read_inbox_max.put(Long.valueOf(((TL_dialog)v8_1).id), Integer.valueOf(Math.max(((Integer)v9).intValue(), ((TL_dialog)v8_1).read_inbox_max_id)));
                    v9 = v6.dialogs_read_outbox_max.get(Long.valueOf(((TL_dialog)v8_1).id));
                    if(v9 == null) {
                        v9_3 = Integer.valueOf(0);
                    }

                    v6.dialogs_read_outbox_max.put(Long.valueOf(((TL_dialog)v8_1).id), Integer.valueOf(Math.max(((Integer)v9).intValue(), ((TL_dialog)v8_1).read_outbox_max_id)));
                }
                ...
                label_296:
                    if(!(((Message)v5).action instanceof TL_messageActionChatMigrateTo)) {
                        if((((Message)v5).action instanceof TL_messageActionChannelCreate)) {
                            ...
                            boolean v8_3 = ((Integer)v9).intValue() < ((Message)v5).id ? true : false;
    ...
    public void sendTyping(long arg9, int arg11, int arg12) {
        ...
        label_38:
            ...
            if(arg11 == 0) {
                ...
                TL_sendMessageGamePlayAction v1_8 = new TL_sendMessageGamePlayAction();
                goto label_44;
            }
            else if(arg11 == 7) {
            ...
            label_44:
                v2_1.action = ((SendMessageAction)v1_11);
            }
