...
public class ApplicationLoader extends a implements LinphoneCoreListener {
    ...
    public void onCreate() {
        ...
        if("talagram".contentEquals("gram")) {
        ...
        if((org.telegram.customization.util.j.d(this.getApplicationContext())) || (org.telegram.customization.util.j.i(this.getApplicationContext()))) {
            if(("talagram".contentEquals("hotgram")) || ("talagram".contentEquals("vip"))) {
                v1_2 = "hotgram";
            }
            else if("talagram".contentEquals("talagram")) {
                v1_2 = "talagram";
            }
            else if("talagram".contentEquals("mowjgram")) {
                v1_2 = "mowjgram";
            }
            else if("talagram".contentEquals("gram")) {
                v1_2 = "Default";
            }
            else {
                v1_2 = "Arabgram";
