...
public class FileUploadOperation {
    ...
    private void startUploadRequest() {
        ...
        try {
            ...
            label_391:
                ...
                if(v12.isBigFile) {
                    ...
                    v2_3.bytes = v5_1;
                    TL_upload_saveFilePart v22_1 = v2_3;
                    v9_1 = v3;
                }
        ...
        v4_1 = ((TLObject)v22).getObjectSize() + 4;
        v3 = v12.operationGuid;
        int v28 = v12.slowNetwork ? 4 : v13_2 % 4 << 16 | 4;
        v12.requestTokens.put(v13_2, ConnectionsManager.getInstance(v12.currentAccount).sendRequest(((TLObject)v22), new RequestDelegate(v3, v4_1, v6_1, v13_2, v0_2, v9_1, v10_2, v22) {
            public void run(TLObject arg19, TL_error arg20) {
                TL_inputEncryptedFileBigUploaded v15_1;
                TL_inputEncryptedFileBigUploaded v1_3;
                byte[] v17;
                byte[] v16;
                    ...
                    if((v0.this$0.isLastPart) && v0.this$0.currentUploadRequetsCount == 0 && v0.this$0.state == 1) {
                        ...
                        if(v0.this$0.key == null) {
                            if(v0.this$0.isBigFile) {
                                TL_inputFileBig v1_1 = new TL_inputFileBig();
                            }
                            else {
                                v1_2 = new TL_inputFile();
                                ((InputFile)v1_2).md5_checksum = "";
                            }

                            v14 = ((TL_inputFileBig)v1_2);
                            ...
                            if(v0.this$0.isBigFile) {
                                v1_3 = new TL_inputEncryptedFileBigUploaded();
                            }
                            else {
                                TL_inputEncryptedFileUploaded v1_4 = new TL_inputEncryptedFileUploaded();
