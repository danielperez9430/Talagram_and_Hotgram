...
public class ID3v2TagBody {
    ...
    public ID3v2FrameBody frameBody(ID3v2FrameHeader arg11) {
        RangeInputStream v4_2;
        int v7_1;
        ByteArrayInputStream v1_2;
        ...
        if(arg11.isUnsynchronization()) {
            ...
            v1_2 = new ByteArrayInputStream(v0_1, 0, v6);
            v0 = v6;
        }
        ...
        if(!arg11.isEncryption()) {
            if(arg11.isCompression()) {
                ...
                InflaterInputStream v4_1 = new InflaterInputStream(((InputStream)v1_2));
            }
            else {
                v7_1 = v0;
                v4_2 = ((RangeInputStream)v1_2);
            }

            return new ID3v2FrameBody(((InputStream)v4_2), ((long)arg11.getHeaderSize()), v7_1, this.tagHeader, arg11);
        }
