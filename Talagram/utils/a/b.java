...
public class b {
    ...
    public static ArrayList B(Context arg6, String arg7) {
        ...
        try {
            v6_1 = new f().a(b.ax(arg6).a(arg7), new a() {
            }.b());
        }
        catch(Exception v6) {
            v6.printStackTrace();
        ...
        int v1 = 0;
        int v2 = 1;
        if(v6_1 == null || ((ArrayList)v6_1).size() < 1 || (TextUtils.isEmpty(((ArrayList)v6_1).get(0)))) {
            v6_2 = new ArrayList();
    ...
    label_153:
        ...
        if((arg7.equals("set-1066")) || (arg7.equals("set-1065")) || (arg7.equals("set-1067"))) {
            ...
            ((ArrayList)v6_1).addAll(((Collection)v7));
        }

        v7 = new ArrayList();
        Iterator v6_3 = ((ArrayList)v6_1).iterator();
        while(v6_3.hasNext()) {
    ...
    public static ArrayList v(Context arg25) {
        ...
        if(TextUtils.isEmpty(((CharSequence)v1))) {
            ...
            DialogTab v2 = new DialogTab(2131493109, 2131231636, "TAB_UNREAD_CHATS", true, 11, LocaleController.getString("unreadChats", 2131627083));
