...
public class a {
    ...
    public static Executor a(int arg8, int arg9, g arg10) {
        com.d.a.b.a.a.c v10_1;
        int v10 = arg10 == g.b ? 1 : 0;
        if(v10 != 0) {
            v10_1 = new com.d.a.b.a.a.c();
        }
        else {
            LinkedBlockingQueue v10_2 = new LinkedBlockingQueue();
        }

        return new ThreadPoolExecutor(arg8, arg8, 0, TimeUnit.MILLISECONDS, v10_1, a.a(arg9, "uil-pool-"));
    }
