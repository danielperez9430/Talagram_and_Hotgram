...
public final class zzaf implements Parcelable$Creator {
    ...
    public final Object createFromParcel(Parcel arg17) {
        ...
        label_24:
            ...
            continue;
        label_42:
            Parcelable v8_1 = SafeParcelReader.createParcelable(v0, v2, CardRequirements.CREATOR);
            continue;
        label_26:
            v13_1 = SafeParcelReader.createParcelable(v0, v2, TransactionInfo.CREATOR);
            continue;
        label_46:
        ...
        return new PaymentDataRequest(v6, v7, v8, v9, ((ShippingAddressRequirements)v10_1), v11, ((PaymentMethodTokenizationParameters)v12_1), ((TransactionInfo)v13_1), v14, v15);
    }
