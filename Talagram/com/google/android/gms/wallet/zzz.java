...
public final class zzz implements Parcelable$Creator {
    ...
    public final Object createFromParcel(Parcel arg24) {
        ...
        label_42:
            ...
            continue;
        label_44:
            v16_1 = SafeParcelReader.createTypedArray(v0, v2, CountrySpecification.CREATOR);
            continue;
        label_48:
        ...
        return new MaskedWalletRequest(v6, v7, v8, v9, v10, v11, v12, ((Cart)v13_1), v14, v15, ((CountrySpecification[])v16_1), v17, v18, v19, ((PaymentMethodTokenizationParameters)v20_1), v21, v22);
    }
