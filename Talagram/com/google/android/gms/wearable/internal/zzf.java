...
@Class(creator="AddLocalCapabilityResponseCreator") @Reserved(value={1}) public final class zzf extends AbstractSafeParcelable {
    ...
    @Constructor public zzf(@Param(id=2) int arg1) {
        super();
