...
@Class(creator="RemoveLocalCapabilityResponseCreator") @Reserved(value={1}) public final class zzfy extends AbstractSafeParcelable {
    ...
    @Constructor public zzfy(@Param(id=2) int arg1) {
        super();
