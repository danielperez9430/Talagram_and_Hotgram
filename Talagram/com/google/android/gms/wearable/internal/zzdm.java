...
@Class(creator="GetChannelInputStreamResponseCreator") @Reserved(value={1}) public final class zzdm extends AbstractSafeParcelable {
    public static final Parcelable$Creator CREATOR;
    @Field(id=2) public final int statusCode;
    @Field(id=3) @Nullable public final ParcelFileDescriptor zzdr;

    static {
        zzdm.CREATOR = new zzdn();
    }

    @Constructor public zzdm(@Param(id=2) int arg1, @Param(id=3) ParcelFileDescriptor arg2) {
        super();
