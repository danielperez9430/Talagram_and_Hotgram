...
@Class(creator="PutDataResponseCreator") @Reserved(value={1}) public final class zzfu extends AbstractSafeParcelable {
    public static final Parcelable$Creator CREATOR;
    @Field(id=2) public final int statusCode;
    @Field(id=3) public final zzdd zzdy;

    static {
        zzfu.CREATOR = new zzfv();
    }

    @Constructor public zzfu(@Param(id=2) int arg1, @Param(id=3) zzdd arg2) {
        super();
