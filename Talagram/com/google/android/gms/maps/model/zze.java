...
public final class zze implements Parcelable$Creator {
    ...
    public final Object createFromParcel(Parcel arg6) {
        ...
        while(arg6.dataPosition() < v0) {
            ...
            continue;
        label_10:
            v2_1 = SafeParcelReader.createParcelable(arg6, v3, LatLng.CREATOR);
            continue;
        label_13:
            v1_1 = SafeParcelReader.createParcelable(arg6, v3, LatLng.CREATOR);
        }

        SafeParcelReader.ensureAtEnd(arg6, v0);
        return new LatLngBounds(((LatLng)v1_1), ((LatLng)v2_1));
    }
