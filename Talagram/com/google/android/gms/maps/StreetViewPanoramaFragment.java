...
@TargetApi(value=11) public class StreetViewPanoramaFragment extends Fragment {
    @VisibleForTesting final class zza implements StreetViewLifecycleDelegate {
        ...
        public final void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback arg3) {
            try {
                this.zzbt.getStreetViewPanoramaAsync(new zzah(this, arg3));
                return;
            }
    ...
    public static StreetViewPanoramaFragment newInstance(StreetViewPanoramaOptions arg3) {
        StreetViewPanoramaFragment v0 = new StreetViewPanoramaFragment();
    ...
    public void onActivityCreated(Bundle arg2) {
        if(arg2 != null) {
            arg2.setClassLoader(StreetViewPanoramaFragment.class.getClassLoader());
        }
    ...
    @SuppressLint(value={"NewApi"}) public void onInflate(Activity arg3, AttributeSet arg4, Bundle arg5) {
        ...
        try {
            ...
            zzb.zza(this.zzbs, arg3);
            this.zzbs.onInflate(arg3, new Bundle(), arg5);
        }
        catch(Throwable v3) {
    ...
    public void onSaveInstanceState(Bundle arg2) {
        ...
        this.zzbs.onSaveInstanceState(arg2);
    }
