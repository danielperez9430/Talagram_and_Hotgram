...
public class SupportMapFragment extends Fragment {
    @VisibleForTesting final class zza implements MapLifecycleDelegate {
        ...
        public final void getMapAsync(OnMapReadyCallback arg3) {
            try {
                this.zzba.getMapAsync(new zzak(this, arg3));
                return;
            }
            ...
            if(this.zzbd != null && this.zzbc != null && this.getDelegate() == null) {
                try {
                    ...
                    if(v0_1 == null) {
                        ...
                        this.zzbc.onDelegateCreated(new zza(this.fragment, v0_1));
    ...
    private final zzb zzcg;

    public SupportMapFragment() {
        super();
        this.zzcg = new zzb(((Fragment)this));
    }

    public void getMapAsync(OnMapReadyCallback arg2) {
        Preconditions.checkMainThread("getMapAsync must be called on the main thread.");
        this.zzcg.getMapAsync(arg2);
    }
    ...
    public static SupportMapFragment newInstance(GoogleMapOptions arg3) {
        SupportMapFragment v0 = new SupportMapFragment();
    ...
    public void onActivityCreated(Bundle arg2) {
        if(arg2 != null) {
            arg2.setClassLoader(SupportMapFragment.class.getClassLoader());
        }
    ...
    public void onInflate(Activity arg4, AttributeSet arg5, Bundle arg6) {
    ...
    public void onSaveInstanceState(Bundle arg2) {
        ...
        this.zzcg.onSaveInstanceState(arg2);
    }
