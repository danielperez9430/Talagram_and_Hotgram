...
@Class(creator="SafeParcelResponseCreator") @VisibleForTesting public class SafeParcelResponse extends FastSafeParcelableJsonResponse {
    ...
    private final void zza(StringBuilder arg10, Map arg11, Parcel arg12) {
        ...
        label_77:
            this.zzb(arg10, ((com.google.android.gms.common.server.response.FastJsonResponse$Field)v5), ((FastJsonResponse)this).getOriginalValue(((com.google.android.gms.common.server.response.FastJsonResponse$Field)v5), v3_10));
        }
        else {
