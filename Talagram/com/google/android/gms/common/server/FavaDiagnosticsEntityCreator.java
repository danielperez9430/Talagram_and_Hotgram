...
public class FavaDiagnosticsEntityCreator implements Parcelable$Creator {
    ...
    public FavaDiagnosticsEntity createFromParcel(Parcel arg7) {
    ...
    public FavaDiagnosticsEntity[] newArray(int arg1) {
