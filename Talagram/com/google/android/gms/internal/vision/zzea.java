...
final class zzea {
    static String zza(zzdx arg2, String arg3) {
    ...
    private static void zza(zzdx arg12, StringBuilder arg13, int arg14) {
        boolean v4_4;
        zzbo v4_3;
        String v8;
        String v6_1;
        ...
        while(v2_1.hasNext()) {
            ...
            if((v4_1.endsWith("List")) && !v4_1.endsWith("OrBuilderList") && !v4_1.equals("List")) {
                ...
                zzea.zza(arg13, arg14, zzea.zzj(v6_1), zzcr.zza(((Method)v8_1), arg12, new Object[0]));
                continue;
            }
        ...
        label_70:
            if((v4_1.endsWith("Map")) && !v4_1.equals("Map")) {
                ...
                zzea.zza(arg13, arg14, zzea.zzj(v6_1), zzcr.zza(((Method)v3_1), arg12, new Object[0]));
                continue;
            }
        ...
        label_107:
            ...
            v6_2 = zzcr.zza(((Method)v6_2), arg12, new Object[0]);
            if(v4_2 == null) {
            ...
            label_220:
                ...
                v4_4 = zzcr.zza(((Method)v4_2), arg12, new Object[0]).booleanValue();
            }
        ...
        label_228:
            ...
            zzea.zza(arg13, arg14, zzea.zzj(v3_2), v6_2);
        }

        if((arg12 instanceof zzc)) {
            Iterator v0_1 = arg12.zzkx.iterator();
            if(!v0_1.hasNext()) {
            }
            else {
                v0_1.next().getKey();
        ...
        if(((zzcr)arg12).zzkr != null) {
            ((zzcr)arg12).zzkr.zza(arg13, arg14);
        }
    }
    ...
    static final void zza(StringBuilder arg4, int arg5, String arg6, Object arg7) {
        ...
        if((arg7 instanceof List)) {
            ...
            while(v7.hasNext()) {
                zzea.zza(arg4, arg5, arg6, v7.next());
            }
        ...
        if((arg7 instanceof String)) {
            arg4.append(": \"");
            arg4.append(zzfb.zzd(zzbo.zzg(((String)arg7))));
            arg4.append(v1_1);
            return;
        }
        ...
        if((arg7 instanceof zzbo)) {
            arg4.append(": \"");
            arg4.append(zzfb.zzd(((zzbo)arg7)));
            arg4.append(v1_1);
            return;
        }

        if((arg7 instanceof zzcr)) {
            arg4.append(" {");
            zzea.zza(((zzdx)arg7), arg4, arg5 + 2);
            arg4.append("\n");
            goto label_55;
        }
        ...
        if((arg7 instanceof Map$Entry)) {
            arg4.append(" {");
            int v6 = arg5 + 2;
            zzea.zza(arg4, v6, "key", ((Map$Entry)arg7).getKey());
            zzea.zza(arg4, v6, "value", ((Map$Entry)arg7).getValue());
            arg4.append("\n");
        }
        else {
            arg4.append(": ");
