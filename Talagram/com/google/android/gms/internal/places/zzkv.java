...
public final class zzkv {
    private static void zzb(String arg12, Object arg13, StringBuffer arg14, StringBuffer arg15) {
        int v12;
        String v13;
        int v3_1;
        Method v7_3;
        ...
        int v4_1;
        if(arg13 != null) {
            if((arg13 instanceof zzku)) {
                int v0 = arg14.length();
                if(arg12 != null) {
                    arg15.append(arg14);
                    arg15.append(zzkv.zzq(arg12));
                    arg15.append(" <\n");
                    arg14.append("  ");
                }
                    ...
                    if(!"cachedSize".equals(v9) && (v8 & 1) == 1 && (v8 & 8) != 8 && !v9.startsWith("_") && !v9.endsWith("_")) {
                        ...
                        if((v8_1.isArray()) && v8_1.getComponentType() != Byte.TYPE) {
                            ...
                            for(v10 = 0; true; ++v10) {
                                ...
                                zzkv.zzb(v9, Array.get(v7_1, v10), arg14, arg15);
                            }
                        }

                        zzkv.zzb(v9, v7_1, arg14, arg15);
                    }
                ...
                for(v5 = 0; v5 < v4_1; ++v5) {
                    ...
                    if(v6_1.startsWith("set")) {
                        ...
                        zzkv.zzb(v6_1, v7_3.invoke(arg13), arg14, arg15);
                    }
    ...
    public static String zze(zzku arg3) {
        String v3_2;
        String v0_1;
        if(arg3 == null) {
            return "";
        ...
        String v1 = null;
        try {
            zzkv.zzb(v1, arg3, new StringBuffer(), v0);
        }
    ...
    private static String zzq(String arg4) {
        StringBuffer v0 = new StringBuffer();
        int v1;
