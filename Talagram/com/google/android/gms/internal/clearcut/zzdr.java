...
final class zzdr {
    static String zza(zzdo arg2, String arg3) {
    ...
    private static void zza(zzdo arg12, StringBuilder arg13, int arg14) {
        boolean v4_4;
        zzbb v4_3;
        String v8;
        String v6_1;
        ...
        while(v2_1.hasNext()) {
            ...
            if((v4_1.endsWith("List")) && !v4_1.endsWith("OrBuilderList") && !v4_1.equals("List")) {
                ...
                zzdr.zza(arg13, arg14, zzdr.zzj(v6_1), zzcg.zza(((Method)v8_1), arg12, new Object[0]));
                continue;
            }
        ...
        label_70:
            if((v4_1.endsWith("Map")) && !v4_1.equals("Map")) {
                ...
                zzdr.zza(arg13, arg14, zzdr.zzj(v6_1), zzcg.zza(((Method)v3_1), arg12, new Object[0]));
                continue;
            }
        ...
        label_107:
            ...
            v6_2 = zzcg.zza(((Method)v6_2), arg12, new Object[0]);
            if(v4_2 == null) {
            ...
            label_220:
                ...
                v4_4 = zzcg.zza(((Method)v4_2), arg12, new Object[0]).booleanValue();
            }
        ...
        label_228:
            ...
            zzdr.zza(arg13, arg14, zzdr.zzj(v3_2), v6_2);
        }

        if((arg12 instanceof zzd)) {
            Iterator v0_1 = arg12.zzjv.iterator();
            while(v0_1.hasNext()) {
                ...
                v4_5.append(v2_2);
                v4_5.append("]");
                zzdr.zza(arg13, arg14, v4_5.toString(), ((Map$Entry)v1_1).getValue());
            }
        }

        if(((zzcg)arg12).zzjp != null) {
            ((zzcg)arg12).zzjp.zza(arg13, arg14);
        }
    }

    static final void zza(StringBuilder arg4, int arg5, String arg6, Object arg7) {
        char v2;
        Iterator v7;
        if((arg7 instanceof List)) {
            v7 = ((List)arg7).iterator();
            while(v7.hasNext()) {
                zzdr.zza(arg4, arg5, arg6, v7.next());
            }
        ...
        if((arg7 instanceof String)) {
            arg4.append(": \"");
            arg4.append(zzet.zzc(zzbb.zzf(((String)arg7))));
            arg4.append(v1_1);
            return;
        }
        ...
        if((arg7 instanceof zzbb)) {
            arg4.append(": \"");
            arg4.append(zzet.zzc(((zzbb)arg7)));
            arg4.append(v1_1);
            return;
        }

        if((arg7 instanceof zzcg)) {
            arg4.append(" {");
            zzdr.zza(((zzdo)arg7), arg4, arg5 + 2);
            arg4.append("\n");
            goto label_55;
        }
        ...
        if((arg7 instanceof Map$Entry)) {
            arg4.append(" {");
            int v6 = arg5 + 2;
            zzdr.zza(arg4, v6, "key", ((Map$Entry)arg7).getKey());
            zzdr.zza(arg4, v6, "value", ((Map$Entry)arg7).getValue());
            arg4.append("\n");
        }
        else {
            arg4.append(": ");
    ...
    private static final String zzj(String arg4) {
        StringBuilder v0 = new StringBuilder();
        int v1;
