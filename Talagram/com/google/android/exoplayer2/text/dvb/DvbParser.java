    ...
    public List decode(byte[] arg28, int arg29) {
        ...
        for(v5 = 0; v5 < v3.size(); ++v5) {
            ...
            if(v10 == null) {
                ...
                if(v10 == null) {
                    v10_1 = v0.defaultClutDefinition;
                }
            }
            ...
            while(v14_1 < v15_1.size()) {
                ...
                if(v11_1 != null) {
                    ...
                    v20 = v14_1;
                    v4 = v15_1;
                    DvbParser.paintPixelDataSubBlocks(((ObjectData)v11_1), v10_1, ((RegionComposition)v7).depth, ((RegionObject)v12).horizontalPosition + v8, v6_1 + ((RegionObject)v12).verticalPosition, v16, v0.canvas);
                }
                else {
                    v20 = v14_1;
                    v4 = v15_1;
            ...
            if(((RegionComposition)v7).fillFlag) {
                if(((RegionComposition)v7).depth == 3) {
                    v4_1 = v10_1.clutEntries8Bit[((RegionComposition)v7).pixelCode8Bit];
                }
                else if(((RegionComposition)v7).depth == 2) {
                    v4_1 = v10_1.clutEntries4Bit[((RegionComposition)v7).pixelCode4Bit];
                }
                else {
                    v4_1 = v10_1.clutEntries2Bit[((RegionComposition)v7).pixelCode2Bit];
                }
