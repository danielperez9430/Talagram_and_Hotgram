...
public class DashManifestParser extends DefaultHandler implements Parser {
        ...
        while(true) {
            ...
            label_124:
                ...
                if(XmlPullParserUtil.isStartTag(v1, "SegmentBase")) {
                    ...
                    SegmentList v0_4 = v15.parseSegmentList(v1, v28);
                }
                else if(XmlPullParserUtil.isStartTag(v1, "SegmentTemplate")) {
                    v0_5 = v15.parseSegmentTemplate(v1, v28);
                }
                else {
                    goto label_207;
                }

                SingleSegmentBase v28_1 = ((SingleSegmentBase)v0_5);
                v8_1 = v2_1;
                v7_1 = v36;
                goto label_220;
            label_207:
    ...
    protected Pair parseContentProtection(XmlPullParser arg17) {
        ...
        label_88:
            ...
            if(XmlPullParserUtil.isEndTag(v0, "ContentProtection")) {
                if(v10_1 != null) {
                    v0_1 = new SchemeData(v10_1, v11, "video/mp4", v13, v14);
                }
                else {
                    Object v0_2 = v2;
                }

                return Pair.create(v6_3, v0_1);
            }
    ...
    protected RepresentationInfo parseRepresentation(XmlPullParser arg25, String arg26, String arg27, String arg28, String arg29, int arg30, int arg31, float arg32, int arg33, int arg34, String arg35, int arg36, List arg37, SegmentBase arg38) {
        ...
        while(true) {
            ...
            if(XmlPullParserUtil.isStartTag(v0, "BaseURL")) {
                ...
                v10_2 = v15.parseSegmentList(v0, ((SegmentList)v10));
                goto label_44;
            }
            else if(XmlPullParserUtil.isStartTag(v0, "SegmentTemplate")) {
                SegmentTemplate v10_3 = v15.parseSegmentTemplate(v0, ((SegmentTemplate)v10));
            label_44:
                v19 = v2;
            }
        ...
        label_96:
            Object v20 = v17;
            SegmentBase v17_1 = ((SegmentBase)v10_2);
            if(XmlPullParserUtil.isEndTag(v0, "Representation")) {
                ...
                if(v17_1 != null) {
                    ...
                    v17_2 = new SingleSegmentBase();
                }

                return new RepresentationInfo(v0_1, v19, ((SegmentBase)v17_2), v20, v23, v22, -1);
            }
    ...
    protected SegmentList parseSegmentList(XmlPullParser arg20, SegmentList arg21) {
        ...
        if(v1 != null) {
            ...
            v2_2 = v1.mediaSegments;
        }

    label_60:
        return this.buildSegmentList(v3_1, v9, v11, v13, v15, v4, ((ArrayList)v2_2));
    }
