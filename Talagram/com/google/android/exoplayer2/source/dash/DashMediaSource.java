...
public final class DashMediaSource extends BaseMediaSource {
    final class DashTimeline extends Timeline {
        ...
        public com.google.android.exoplayer2.Timeline$Period getPeriod(int arg12, com.google.android.exoplayer2.Timeline$Period arg13, boolean arg14) {
            ...
            Integer v0 = null;
            if(arg14) {
                String v4 = this.manifest.getPeriod(arg12).id;
            }
            else {
                v4_1 = v0;
            }
            ...
            return arg13.set(v4_1, v0, 0, this.manifest.getPeriodDurationUs(arg12), C.msToUs(this.manifest.getPeriod(arg12).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
