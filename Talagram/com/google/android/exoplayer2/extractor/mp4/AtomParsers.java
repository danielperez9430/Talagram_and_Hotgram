...
final class AtomParsers {
    ...
    label_107:
        ...
        if(v2_1.format == null) {
            ...
            if(v3_1 != null) {
                ...
                v5 = -1;
                v6 = -1;
                List v8_1 = (((byte[])v18_1)) == null ? ((List)v15) : Collections.singletonList(v18_1);
    ...
    public static TrackSampleTable parseStbl(Track arg52, ContainerAtom arg53, GaplessInfoHolder arg54) {
        ...
        if(v3 != null) {
            ...
            if(v3 != null) {
                Stz2SampleSizeBox v4_1 = new Stz2SampleSizeBox(v3);
            }
            else {
                goto label_610;
            }
        ...
        int v3_1 = ((SampleSizeBox)v4).getSampleCount();
        if(v3_1 == 0) {
        ...
        int v5 = !((SampleSizeBox)v4).isFixedSampleSize() || !"audio/raw".equals(v1.format.sampleMimeType) || v8_1 != 0 || v15 != 0 || v6_2 != 0 ? 0 : 1;
        long v18 = 0;
        if(v5 == 0) {
            ...
            while(v8_1 < v3_1) {
                ...
                v9_1 = v25;
                v5_1[v8_1] = v21_1;
                v12_1[v8_1] = ((SampleSizeBox)v4).readNextSampleSize();
                if(v12_1[v8_1] > v1_1) {
                    v1_1 = v12_1[v8_1];
                }

                StszSampleSizeBox v33 = v4;
                v34 = v5_1;
    ...
    public static Track parseTrak(ContainerAtom arg22, LeafAtom arg23, long arg24, DrmInitData arg26, boolean arg27, boolean arg28) {
        ...
        Track v0_2 = v4_2.format == null ? v2 : new Track(TkhdData.access$100(v3), v5, v1_1.first.longValue(), v14, v10, v4_2.format, v4_2.requiredSampleTransformation, v4_2.trackEncryptionBoxes, v4_2.nalUnitLengthFieldLength, ((long[])v16), ((long[])v17));
        return v0_2;
    }
