...
public final class AudioCapabilitiesReceiver {
    ...
    public AudioCapabilitiesReceiver(Context arg2, Listener arg3) {
        HdmiAudioPlugBroadcastReceiver v2;
        super();
        ...
        if(Util.SDK_INT >= 21) {
            v2 = new HdmiAudioPlugBroadcastReceiver(this, v3);
        }
        else {
            BroadcastReceiver v2_1 = ((BroadcastReceiver)v3);
        }

        this.receiver = ((BroadcastReceiver)v2);
    }
