...
@SuppressLint(value={"InlinedApi"}) @TargetApi(value=16) public final class MediaCodecUtil {
    ...
    public static com.google.android.exoplayer2.mediacodec.MediaCodecInfo getDecoderInfo(String arg0, boolean arg1) {
        com.google.android.exoplayer2.mediacodec.MediaCodecInfo v0_1;
    ...
    public static List getDecoderInfos(String arg6, boolean arg7) {
        ...
        label_9:
            ...
            int v4 = 21;
            if(Util.SDK_INT >= v4) {
                v2_1 = new MediaCodecListCompatV21(arg7);
            }
            else {
                v2_2 = new MediaCodecListCompatV16(v3);
            }

            ArrayList v5 = MediaCodecUtil.getDecoderInfosInternal(v1, ((MediaCodecListCompat)v2_1), arg6);
            ...
            if("audio/eac3-joc".equals(arg6)) {
                v5.addAll(MediaCodecUtil.getDecoderInfosInternal(new CodecKey("audio/eac3", v1.secure), ((MediaCodecListCompat)v2_1), arg6));
            }
