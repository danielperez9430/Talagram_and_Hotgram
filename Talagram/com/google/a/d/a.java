...
public class a implements Closeable {
    final class com.google.a.d.a$1 extends e {
        com.google.a.d.a$1() {
            super();
        }

        public void a(a arg4) {
            if((arg4 instanceof com.google.a.b.a.e)) {
                ((com.google.a.b.a.e)arg4).o();
                return;
            }
    ...
    static {
        a.b = ")]}\'\n".toCharArray();
        e.a = new com.google.a.d.a$1();
    }

    public a(Reader arg5) {
        super();
        this.d = false;
        ...
        while(true) {
            ...
            if(this.e[this.f] == 10) {
                ...
                while(true) {
                    ...
                    else if(this.e[this.f + v3] == arg6.charAt(v3)) {
                        ++v3;
                        continue;
                    }
    ...
    private IOException b(String arg3) {
        ...
        v1.append(arg3);
        v1.append(this.s());
        throw new d(v1.toString());
    }

    private String b(char arg10) {
        int v5;
        char[] v0 = this.e;
    ...
    private void z() {
        this.b(true);
        --this.f;
        if(this.f + a.b.length > this.g && !this.b(a.b.length)) {
            return;
        }

        int v0;
        for(v0 = 0; v0 < a.b.length; ++v0) {
            if(this.e[this.f + v0] != a.b[v0]) {
                return;
            }
        }
