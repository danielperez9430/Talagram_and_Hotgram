...
final class cw {
    ...
    private static void a(fp arg21, int arg22, int arg23, int arg24, int arg25, long arg26, int arg28, d arg29, int arg30) {
        ...
        v4.b = bj.a(Integer.toString(arg25), v7, -1, -1, arg26, v12, v13, v14, arg28, v16, v17, v18, null);
    }
    ...
    public static dg a(dd arg44, com.google.ads.interactivemedia.v3.internal.cv$a arg45) {
        ...
        int v4 = !((c)v3_1).c() || !"audio/raw".equals(v0.l.b) || v7_1 != 0 || v14 != 0 || v5_2 != 0 ? 0 : 1;
        long v17 = 0;
        if(v4 == 0) {
            v4_1 = new long[v2_1];
            v11_1 = new int[v2_1];
    ...
    private static Pair b(fp arg12, int arg13) {
        ...
        if(v4 == 0) {
            ...
            List v12_1 = Collections.singletonList(v1_1);
        }

        return Pair.create(v12, Integer.valueOf(arg13 + 1));
    }
